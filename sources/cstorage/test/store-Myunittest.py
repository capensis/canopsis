...
from pyperfstore3.store.timed import TimedStore
from pyperfstore3.timewindow import TimeWindow


class TimedStoreTest(unittest.TestCase):
	"""
	pyperfstore3.store.TimedStore UT on data_type = "test_store"
	"""

	def setUp(self):
		# create a store on test_store collections
		self.store = TimedStore(data_type="test_store")
...
from pyperfstore3.store.periodic import PeriodicStore
...
class PeriodicStoreTest(unittest.TestCase):
	...
	def setUp(self):
		# create a store on test_store collections
		self.store = PeriodicStore(data_type="test_store")
