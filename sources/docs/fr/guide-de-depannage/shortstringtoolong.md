...
Comme expliqué dans la documentation de l'[API `event`](../guide-developpement/api/api-v2-event.md) ceci est du à la longueur de la clé de routage. Si cette clé dépasse 255 caractères, RabbitMQ renvoie ce type d'erreur.
