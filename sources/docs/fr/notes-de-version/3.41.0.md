...
*  **Documentation :**
    ...
    *  Mise à jour de la documentation des helpers handelbars pour prendre en compte l'ajout de l'option "case sensitive" ([#2346](https://git.canopsis.net/canopsis/canopsis/issues/2346))
