...
infos popups et de la modal *More infos* a été modifiée. Elle contient
...
* **UI :**
    ...
    * **Météo des services :**
        * Correction d'un bug sur le filtre appliqué à la modal Bac à alarmes
        * Ajout de la fonctionnalité de customisation du nom des entités, sur la modal "Plus d'infos"
