...
*  **Documentation :**
    ...
    *  Ajout d'une documentation sur la procédure de changement de verbosité des moteurs Python ([#1659](https://git.canopsis.net/canopsis/canopsis/issues/1659))
    *  Amélioration de la documentation des templates de webhooks, et ajout de documentation sur les nouveaux opérateurs `split` et `trim` ([#6](https://git.canopsis.net/cat/go-engines/issues/6))
    *  Modification de la procédure de mise à jour, afin de prendre en compte les nouvelles options de `canopsinit` ([#1655](https://git.canopsis.net/canopsis/canopsis/issues/1655))
