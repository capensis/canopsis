...
*  **Moteurs :**
    *  **Moteurs nouvelle génération (Go) :**
        ...
        *  webhooks (plugin CAT) : ajout d'une option `disable_if_active_pbehavior` aux webhooks, permettant de désactiver le webhook si un pbehavior est actif sur l'entité ([#100](https://git.canopsis.net/canopsis/go-engines/issues/100))
