...
**Attention :** Sur Debian 9, le paquet Canopsis Core 3.24.0 nécessite d'activer les dépôts `non-free` de Debian. Ceci n'est plus nécessaire à partir de [Canopsis 3.25.0](3.25.0.md).
