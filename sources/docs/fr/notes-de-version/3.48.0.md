...
Si vous créé vos propres scripts utilisant l'API `/api/v2/eventfilter`, vous devez vous assurer de les synchroniser avec les dernières mises à jour de la [documentation de cette API](../guide-developpement/api/api-v2-event-filter.md), notamment sur le champ `patterns`.
