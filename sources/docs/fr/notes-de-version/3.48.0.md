...
*  **UI :**
    *  **Gestion des event filters**
        *  Modification de l'interface pour permettre la création de plusieurs patterns ([#2740](https://git.canopsis.net/canopsis/canopsis/-/issues/2741))
    *  **Gestion des dynamic info**
        *  Il est désormais possible d'effectuer une rechercher avancée sur le `pattern` ([#2741](https://git.canopsis.net/canopsis/canopsis/-/issues/2741))
    *  **Gestion des droits**
