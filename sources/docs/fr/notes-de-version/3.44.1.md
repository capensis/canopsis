...
*  **Documentation :**
    * Ajout d'informations dans la [documentation du moteur action](../guide-administration/moteurs/moteur-action/moteur-action.md) ([#2508](https://git.canopsis.net/canopsis/canopsis/-/issues/2508))
    * Remise en forme de la [documentation du moteur webhook](../guide-administration/moteurs/moteur-webhook/moteur-webhook.md) et ajout des [triggers](../guide-administration/architecture-interne/triggers.md) `statusinc` et `statusdec` ([#2509](https://git.canopsis.net/canopsis/canopsis/-/issues/2509))
    ...
    * Clarification du rôle de `che-cat` dans la [documentation du moteur che](../guide-administration/moteurs/moteur-che-event_filter.md)
*  **API :**
