...
La value "textuelle" de la criticité reste accessible via un tooltip.
...
Pour le moment, seule l'API [`metaalarmrule`](../guide-developpement/api/api-v2-meta-alarm-rule.md) est éligible. Pour accéder à l'interface associée, vous pouvez utiliser l'URL : **http://IP_Canopsis:port/ui/**
