...
*  **Documentation :**
    ...
    *  Ajout de documentation sur les champs de date pouvant être appliqués aux objets `CpsTime`, dans la [documentation des templates Go](../guide-administration/webhooks/templates-golang.md#declaration-de-variables)
...
*  **API :**
    *  importctx : ajout de la prise en charge de *l'upsert* dans l'API d'import ([#1523](https://git.canopsis.net/canopsis/canopsis/issues/1523))
