...
*  **Images Docker / paquets :**
    ...
    *  Docker : Ajout d'une librairie nécessaire au démarrage de l'image du moteur KPI ([#2687](https://git.canopsis.net/canopsis/canopsis/-/issues/2687))
...
*  **Connecteurs :**
    *  [SNMPtrap_custom](https://doc.canopsis.net/interconnexions/Supervision/SNMPtrap_custom/) (CAT) possède maintenant une option `--publish` ([#51](https://git.canopsis.net/cat/canopsis-cat/-/issues/51))
...
*  **UI :**
    ...
    *  **Gestion des droits**
        ...
        *  Certaines fonctionnalités de l'édition CAT apparaissaient dans le menu d'exploitation de l'édition Core ([#2672](https://git.canopsis.net/canopsis/canopsis/-/issues/2672))
    *  **Gestion des utilisateurs**
        ...
        * Les attributs nom et prénom de l'utilisateur `root` ne supportaient pas les caractères non-ASCII ([#2680](https://git.canopsis.net/canopsis/canopsis/-/issues/2680))
        * Un bug impactait parfois la modification des droits pour le role admin ([#2677](https://git.canopsis.net/canopsis/canopsis/-/issues/2677))
    *  **Grille d'édition**
...
*  **Moteurs :**
    ...
    *  **SNMPtrap_custom (Python)**
        ...
        *  Les classes de `traps custom` sont maintenant chargés dans l'ordre alphabétique. De plus, une nouvelle option est disponible et permet de stopper l'évaluation des traps customs quand une correspondance est trouvée ([#2718](https://git.canopsis.net/canopsis/canopsis/-/issues/2718))
