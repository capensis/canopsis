...
Canopsis 4.0.0 étant une nouvelle [version majeure](../../guide-administration/mise-a-jour/numeros-version-canopsis.md) de Canopsis, la procédure de mise à jour diffère de la procédure habituelle. Un Guide de migration doit **obligatoirement** être suivi pour les installations déjà en place.

*À la date de publication de Canopsis 4.0.0, ce Guide de migration, devant prendre en compte le nombre important de changements introduits dans cette version, est encore en cours d'écriture et de relecture. Cette page sera mise à jour très prochainement dès que ce guide sera publiquement disponible. Pour l'instant, seule une nouvelle installation de Canopsis 4.0.0 est suggérée.*
