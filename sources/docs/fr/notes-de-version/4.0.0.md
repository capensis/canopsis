...
### Refonte de la fonctionnalité PBehavior maintenant nommée Planification

![](./img/4.0.0-planning.png)

#### Ajout de la fonctionnalité Remediation

![](./img/4.0.0-remediation.png)
