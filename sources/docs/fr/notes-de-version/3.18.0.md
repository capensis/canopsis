...
Si vous faites une *nouvelle installation* de Canopsis 3.18.0 (et non pas une simple mise à jour), vous devez [lancer `canopsinit` une seconde fois](../guide-administration/mise-a-jour.md#procedure-standard-de-mise-a-jour), après l'appel à `canoctl`.
