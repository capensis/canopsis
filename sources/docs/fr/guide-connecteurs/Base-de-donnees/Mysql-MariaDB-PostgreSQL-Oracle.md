...
Pré-requis : récupérer et installer Oracle Instant Client et son SDK (`instantclient-basic-linux` et `instantclient-sdk-linux`). Disponibles sur <https://www.oracle.com/technetwork/database/database-technologies/instant-client/overview/index.html> (attention, un compte est nécessaire).
