...
!!! Attention
    Pour garantir un fonctionnement optimal de ce moteur, il est nécessaire d'appliquer [la configuration avancées de Redis](../administration-avancee/configuration-services/serveur-cache-redis.md).
