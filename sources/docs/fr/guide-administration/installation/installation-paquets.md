...
Installation d'une version plus récente de Python 2.7 (pré-requis pour le `webserver` Canopsis, et pour SNMP, en environnement CentOS 7, depuis Canopsis 3.13.0), [depuis SCL](https://www.softwarecollections.org/en/scls/rhscl/python27/) :
```sh
