...
Depuis la `3.44.0` il y a la possibilité de faire des template pour des mail sous forme HTML sans prendre en compte le balisage. Il faut ajouter un `action_template=NO_HTML` au template.
