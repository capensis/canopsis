...
class Wrapper(object):
    def __init__(
        self, filename, viewName, startTime, stopTime, subset_selection,
        account, wrapper_conf_file, orientation='Portrait', pagesize='A4'
    ):
    ...
    def launch_wkhtml(self):
        ...
        self.logger.debug(
            'wkhtmltopdf will be launched with the following command:')
        self.logger.debug(cmd)
