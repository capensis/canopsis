...
from cconfiguration import Configurable, Category, Parameter
...
class DataBase(Configurable):
    ...
    @property
    def foojournaling(self):
        return self._foojournaling

    @foojournaling.setter
    def foojournaling(self, value):
        self._foojournaling = value
        self.reconnect()
    ...
    def size(self, criteria=None, *args, **kwargs):
        """
        Get database size in Bytes

        :parameter criteria: dictionary of field/value which correspond to
    ...
    def _configure(self, unified_configuration, *args, **kwargs):
        ...
        db_properties = (parameter.name for parameter
            in self.configuration[DataBase.DATABASE])
...
class Storage(DataBase):
    ...
    def get_element(self, id, *args, **kwargs):
        """
    ...
    def delete_element(self, id, *args, **kwargs):
        """
        Delete an element identified by the unique input id
    ...
    def update_element(self, id, content, *args, **kwargs):
        """
        Update an element identified by input id

        :param id: element id to update
        :type id: str

        :param content: element content to update (couples of field name,value)
        :type content: dict
    ...
    def _get_table_prefix(self, *args, **kwargs):
        """
        ...
        result = "{0}{1}".format(self._get_storage_type(), self.data_type)
