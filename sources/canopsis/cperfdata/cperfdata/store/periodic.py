...
_Periodic_STORES_BY_DATA_TYPE = dict()


def get_store(data_type, *args, **kwargs):
	global _Periodic_STORES_BY_DATA_TYPE

	result = _Periodic_STORES_BY_DATA_TYPE.get(data_type)

	if result is None:
		result = PeriodicStore(data_type=data_type, *args, **kwargs)
		_Periodic_STORES_BY_DATA_TYPE[data_type] = result
