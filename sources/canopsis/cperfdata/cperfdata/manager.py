...
class Manager(Manager):
	...
	def __init__(self, timed_store=None, periodic_store=None,
		logging_level=logging.INFO, data_type=DEFAULT_DATA_TYPE):
		...
		if timed_store is None:
			timed_store = get_timedstore(
				logging_level=logging_level, data_type=data_type)

		self.timed_store = timed_store

		if periodic_store is None:
			periodic_store = get_periodicstore(
				logging_level=logging_level, data_type=data_type)
