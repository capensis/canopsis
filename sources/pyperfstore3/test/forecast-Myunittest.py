...
from forecastingMethods import *
...
class forecastingMethodsToTest( unittest.TestCase ):
	...
	def test_calculate_seasonality(self) :
		...
		assert linearSeasonality == None, 'Linearity no detected'
...
if __name__ == "__main__":
	...
	test = forecastingMethodsToTest()
	test.test_validate_serie()
	test.test_calculate_RMSE()
	test.test_calculate_mobile_mean()
	test.test_detect_particular_points()
	test.test_calculate_seasonality()
