...
*/
Ext.define('canopsis.controller.SLAMacros', {
	extend: 'canopsis.lib.controller.cgrid',

	views: ['SLAMacros.Form'],
	stores: ['SLAMacros'],
	models: ['SLAMacros'],

	logAuthor: '[controller][SLAMacros]',

	init: function() {
		log.debug('Initialize ...', this.logAuthor);

		this.formXtype = 'SLAMacrosForm';
		this.listXtype = undefined;

		this.modelId = 'SLAMacros';

		this.callParent(arguments);
	},

	slaButton: function(){
		var store = this.getStore('SLAMacros');

		this.grid = this.getController('SLACrit').grid;
