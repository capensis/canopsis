...
window.bricks['canopsis-ui'].schemasArray = [];

define(window.bricks['canopsis-ui'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['canopsis-ui'].schemasArray[i];
        var urlPrefix = 'canopsis/canopsis-ui/schemas/';
