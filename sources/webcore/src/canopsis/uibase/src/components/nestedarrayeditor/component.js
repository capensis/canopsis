...
Ember.Application.initializer({
    name: 'component-nestedarrayeditor',
    ...
    initialize: function(container, application) {
         ...
         *
         * ![Component preview](../screenshots/component-nestedarrayeditor.png)
         */
        var component = Ember.Component.extend(ValidationFieldMixin, {
            ...
            actions: {
                ...
                /**
                 * @method actions_addNestedItem
                 * @argument item 
                 */

                addNestedItem: function(item) {
                    var newNestedItem = {value: {displayable: true, isActive: false, label: ''}}
                    
                    console.log('addNestedItem', get(this, 'value'));

                    var nestedViews = item.get('value.nestedViews');
                    if (!nestedViews) {
                        item.set('value.nestedViews', Ember.A());                    
                    }
                    item.get('value.nestedViews').pushObject(newNestedItem);
                },
                ...
                /**
                 * @method actions_removeNestedItem
                 * @argument parent
                 * @argument nestedItem
                 * 
                 */
                removeNestedItem: function(parent, nestedItem) {
                    console.log('removeNestedItem', get(this, 'value'));

                    parent.get('value.nestedViews').removeObject(nestedItem);
                }
        ...
        application.register('component:component-nestedarrayeditor', component);
    }
});
