...
Ember.Application.initializer({
    ...
    initialize: function(container, application) {
                            ...
                            for (var j = 0, lj = category.keys.length; j < lj; j++) {
                                ...
                                if(key === "separator") {
                                    ...
                                    if (key !== undefined && attr === undefined) {
                                        console.error("An attribute that does not exists seems to be referenced in schema categories" + key);
        ...
        formOptions);
        application.register('form:doneform', form);
    }
});
