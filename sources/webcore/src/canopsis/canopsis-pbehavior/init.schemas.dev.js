...
window.bricks['canopsis-pbehavior'].schemasArray = ["text!canopsis/canopsis-pbehavior/schemas/crecord.ccpbehavior.json"];

define(window.bricks['canopsis-pbehavior'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['canopsis-pbehavior'].schemasArray[i];
        var urlPrefix = 'canopsis/canopsis-pbehavior/schemas/';
