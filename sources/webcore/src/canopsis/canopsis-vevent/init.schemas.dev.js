...
window.bricks['canopsis-vevent'].schemasArray = [];

define(window.bricks['canopsis-vevent'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['canopsis-vevent'].schemasArray[i];
        var urlPrefix = 'canopsis/canopsis-vevent/schemas/';
