...
window.bricks['brick-querybuilder'].schemasArray = [];

define(window.bricks['brick-querybuilder'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['brick-querybuilder'].schemasArray[i];
        var urlPrefix = 'canopsis/brick-querybuilder/schemas/';
