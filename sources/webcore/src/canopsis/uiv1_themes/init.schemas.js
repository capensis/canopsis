...
window.bricks['uiv1_themes'].schemasArray = [];

define(window.bricks['uiv1_themes'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['uiv1_themes'].schemasArray[i];
        var urlPrefix = 'canopsis/uiv1_themes/schemas/';
