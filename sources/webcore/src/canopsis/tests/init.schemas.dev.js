...
window.bricks['tests'].schemasArray = [];

define(window.bricks['tests'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['tests'].schemasArray[i];
        var urlPrefix = 'canopsis/tests/schemas/';
