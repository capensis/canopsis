        ...
        var mixin = Mixin('sendevent', {
            ...
            getDataFromRecord: function(event_type, crecord, formRecord) {
                ...
                var record = {
                    ...
                    ack_resources: get(crecord, 'ack_resources')
                };
                ...
                return new Ember.RSVP.Promise(function(resolve, reject) {
                    ...
                    $.post('/event', {
                        ...
                        Ember.run(function () {
                            ...
                            window.refreshCurrentActiveViewByPass.trigger('refreshCurrentActiveViewByPass');
                            resolve(arguments);
                        });
                    });
                });
            ...
            event_processors: {
                ...
                ackremove: {
                    ...
                    transform: function(crecord, record) {
                        ...
                        crecord.set('ticket_declared_author', undefined);
                        crecord.set('ticket_declared_date', undefined);
