...
window.bricks['userpreferences'].schemasArray = [];

define(window.bricks['userpreferences'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['userpreferences'].schemasArray[i];
        var urlPrefix = 'canopsis/userpreferences/schemas/';
