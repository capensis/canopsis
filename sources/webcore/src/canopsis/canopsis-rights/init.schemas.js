...
window.bricks['canopsis-rights'].schemasArray = [];

define(window.bricks['canopsis-rights'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['canopsis-rights'].schemasArray[i];
        var urlPrefix = 'canopsis/canopsis-rights/schemas/';
