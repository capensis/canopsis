...
import CreateWatcherDeclareTicketEvent from './watcher/createWatcherDeclareTicketEvent.vue';
import CreateWatcherPauseEvent from './watcher/createWatcherPauseEvent.vue';
