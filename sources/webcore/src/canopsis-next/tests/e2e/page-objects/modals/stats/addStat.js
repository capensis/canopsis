...
const commands = {
  ...
  setStatStates(states = []) {
    states.forEach(({ index, value }) => {
      this.setStatState(index, value);
    });
    return this;
  },
  ...
  removeAuthors(value) {
    this.api.useXpath()
      .customClick(this.el('@statAuthor', value))
      .customKeyup('@statAuthor', this.api.Keys.DELETE);
...
module.exports = modalCreator(modalSelector, {
  elements: {
    ...
    statAuthor: './/*[@data-test=\'addStatModal\']//div[@class=\'v-select__selections\']//div[@class=\'v-chip__content\' and contains(text(), \'%s\')]',
