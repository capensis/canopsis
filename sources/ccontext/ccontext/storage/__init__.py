...
class TimedStorage(TimedStorage):
	...
	DEFAULT_CONFIGURATION_FILE = '~/etc/ccontext.conf'
	...
	def entity_by_name(
		...
		data_ccontext=None, data_ccontext_type=None):
		...
		if data_ccontext is not None:
			query[TimedStorage.Index.COMPONENT] = component
			query[TimedStorage.Index.NAME] = data_ccontext
			query[TimedStorage.Index.TYPE] = data_ccontext_type
