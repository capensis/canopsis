...
class OpenTSDBDataBase(DataBase):
    """Manage access to OpenTSDB."""
    ...
    def _connect(self, *args, **kwargs):
        ...
        if self.cache_size:
            connection_args['qsize'] = self.cache_size
...
class OpenTSDBStorage(OpenTSDBDataBase, Storage):
    """Influxdb Storage."""
    ...
    def get_elements(
        ...
        cursor = OpenTSDBCursor(self._conn.query(_query))
