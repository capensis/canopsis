export { default as CAdvancedDataTable } from '@/components/common/table/c-advanced-data-table.vue';
export { default as CTreeviewDataTable } from '@/components/common/table/c-treeview-data-table.vue';
