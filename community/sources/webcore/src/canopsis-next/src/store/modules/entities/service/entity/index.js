...
export default {
  ...
  getters: {
    getListByServiceId: (state, getters, rootState, rootGetters) => serviceId => rootGetters['entities/getList'](ENTITIES_TYPES.weatherService, get(state.services[serviceId], 'allIds', [])),
