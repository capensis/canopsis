...
export default {
  ...
  actions: {
    ...
    fetchEntityServicesVarsWithoutStore(context, { params } = {}) {
      return request.get(API_ROUTES.templateVarsSpecific.entityServices, { params });
    },

    fetchEventFiltersVarsWithoutStore(context, { params } = {}) {
      return request.get(API_ROUTES.templateVarsSpecific.eventFilters, { params });
    },

    fetchScenariosVarsWithoutStore(context, { params } = {}) {
      return request.get(API_ROUTES.templateVarsSpecific.scenarios, { params });
    },

    fetchLinkRulesVarsWithoutStore(context, { params } = {}) {
      return request.get(API_ROUTES.templateVarsSpecific.linkRules, { params });
    },

    fetchWidgetsVarsWithoutStore(context, { params } = {}) {
      return request.get(API_ROUTES.templateVarsSpecific.widgets, { params });
    },
    ...
    fetchMetaAlarmRulesVarsWithoutStore(context, { params } = {}) {
      return request.get(API_ROUTES.templateVarsSpecific.metaAlarmRules, { params });
    },
  },
};
