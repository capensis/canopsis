...
export default createEntityModule({
  ...
  getters: {
    getListByWidgetId: (state, getters, rootState, rootGetters) => widgetId => rootGetters['entities/getList'](ENTITIES_TYPES.service, get(state.widgets[widgetId], 'allIds', [])),
    ...
    getItem: (state, getters, rootState, rootGetters) => id => rootGetters['entities/getItem'](ENTITIES_TYPES.service, id),
  },
  mutations: {
