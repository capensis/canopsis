...
const AdminPermissions = () => import(/* webpackChunkName: "Permissions" */ '@/views/admin/permissions.vue');
const AdminUsers = () => import(/* webpackChunkName: "Users" */ '@/views/admin/users.vue');
const AdminRoles = () => import(/* webpackChunkName: "Roles" */ '@/views/admin/roles.vue');
const AdminParameters = () => import(/* webpackChunkName: "Parameters" */ '@/views/admin/parameters.vue');
const AdminBroadcastMessages = () => import(/* webpackChunkName: "BroadcastMessages" */ '@/views/admin/broadcast-messages.vue');
const AdminPlaylists = () => import(/* webpackChunkName: "Playlists" */ '@/views/admin/playlists.vue');
...
const ExploitationPbehaviors = () => import(/* webpackChunkName: "Pbehaviors" */ '@/views/exploitation/pbehaviors.vue');
const ExploitationEventFilter = () => import(/* webpackChunkName: "EventFilter" */ '@/views/exploitation/event-filter.vue');
const ExploitationSnmpRules = () => import(/* webpackChunkName: "SnmpRules" */ '@/views/exploitation/snmp-rules.vue');
const ExploitationDynamicInfos = () => import(/* webpackChunkName: "DynamicInfos" */ '@/views/exploitation/dynamic-infos.vue');
const ExploitationMetaAlarmRules = () => import(/* webpackChunkName: "MetaAlarmRules" */ '@/views/exploitation/meta-alarm-rules.vue');
const ExploitationScenarios = () => import(/* webpackChunkName: "Scenarios" */ '@/views/exploitation/scenarios.vue');
const ExploitationIdleRules = () => import(/* webpackChunkName: "IdleRules" */ '@/views/exploitation/idle-rules.vue');
