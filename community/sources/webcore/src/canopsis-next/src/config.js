...
export const API_ROUTES = {
  ...
  view: '/api/v4/views',
  viewCopy: '/api/v4/view-copy',
  viewTab: '/api/v4/view-tabs',
  viewTabCopy: '/api/v4/view-tab-copy',
  viewTabPosition: '/api/v4/view-tab-positions',
  widget: '/api/v4/widgets',
  widgetCopy: '/api/v4/widget-copy',
  widgetGridPosition: '/api/v4/widget-grid-positions',
  widgetFilter: '/api/v4/widgetfilters',
  viewExport: '/api/v4/view-export',
  viewImport: '/api/v4/view-import',
