<template lang="pug">
  c-information-block(
    :title="$t('storageSetting.entityArchived.title')",
    :help-text="$t('storageSetting.entityArchived.titleHelp')",
    ...
    v-flex
      v-btn.mx-0.my-4(color="primary", @click="$emit('clean')") {{ $t('storageSetting.entityArchived.cleanArchive') }}
</template>
