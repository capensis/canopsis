  ...
  v-form(@submit.prevent="submit")
    modal-wrapper(close)
      template(#title="")
        span {{ title }}
      template(#text="")
        widget-more-infos-template-form(v-model="form")
      template(#actions="")
...
import WidgetMoreInfosTemplateForm from '@/components/other/widget-template/widget-more-infos-template-form.vue';
