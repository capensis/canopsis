    ...
    div(v-if="alarm.v.ticket")
      v-tooltip(top)
        ...
        div.text-md-center(:data-test="`extraDetailsContent-${alarm._id}`")
          ...
          div {{ $t('common.date') }} : {{ alarm.v.ticket.t | dateWithToday('long') }}
          div(
    ...
    div(v-if="alarm.v.canceled")
      v-tooltip(top)
        ...
        div.text-md-center(:data-test="`extraDetailsContent-${alarm._id}`")
          ...
          div {{ $t('common.date') }} : {{ alarm.v.canceled.t | dateWithToday('long') }}
      ...
      v-tooltip(top)
        ...
        div(:data-test="`extraDetailsContent-${alarm._id}`")
          ...
          div
            ...
            div {{ alarm.pbehavior.tstart | dateWithToday('long') }}
              template(v-if="alarm.pbehavior.tstop")
                |  - {{ alarm.pbehavior.tstop | dateWithToday('long') }}
