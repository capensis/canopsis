...
export default {
  ...
  instructionStat: {
    ...
    averageAlarmOkTimeout: 'Average time\nafter remediation end,\nbefore ok state',
    averageSuccessfulAllOk: 'Successful \ninstructions \n(all / OK only)',
    averageSuccessfulAll: 'Successful \ninstructions \n(resulting all states)',
    averageSuccessfulOk: 'Successful \ninstructions \n(resulting OK state)',
