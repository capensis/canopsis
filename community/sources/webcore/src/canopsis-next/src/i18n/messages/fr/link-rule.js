...
export default {
  ...
  alarmListParameters: 'Paramètres de la liste d\'alarmes',
  actionType: 'Type d\'action',
  massRemove: 'Supprimer les règles de lien',
  massEnable: 'Activer les règles de lien',
  massDisable: 'Désactiver les règles de lien',
  types: {
