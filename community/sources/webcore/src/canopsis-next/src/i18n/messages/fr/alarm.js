...
export default {
  ...
  timeline: {
    ...
    steps: {
      ...
      [ALARM_LIST_STEPS.webhookProgress]: 'Webhook exécuté par {author} en cours...',
      ...
      [ALARM_LIST_STEPS.declareTicketRuleProgress]: 'Règle de déclaration de ticket exécutée par {author} en cours',
      [ALARM_LIST_STEPS.declareTicketRuleComplete]: 'Règle de déclaration du ticket terminée',
      [ALARM_LIST_STEPS.declareTicketRuleFailed]: 'Règle de déclaration de ticket en échec',
