...
export default {
  ...
  timeline: {
    ...
    steps: {
      ...
      [ALARM_LIST_STEPS.webhookInProgress]: 'Webhook lancé par {author} en cours...',
      ...
      [ALARM_LIST_STEPS.declareTicketRuleInProgress]: 'Règle de déclaration de ticket lancée par {author} en cours',
      [ALARM_LIST_STEPS.declareTicketRuleComplete]: 'La règle de déclaration du ticket est terminée',
      [ALARM_LIST_STEPS.declareTicketRuleFail]: 'La règle de déclaration de ticket a échoué',
