...
export default {
  ...
  alarmFilteringTime: 'Alarm filtering time',
  lastFilteringDate: 'Last filtering date',
  runAlarmFiltering: 'Run alarm filtering',
  alarmFilteringInProgress: 'Alarm filtering in progress',
  alarmFilteringError: 'Alarm filtering error',
