...
export default {
  ...
  search: {
    ...
    contextAdvancedSearch: '<span>Aide sur la recherche avancée :</span>\n' +
      ...
      '<p>Opérateurs:\n' +
      '    <=, <,=, !=,>=, >, LIKE (Pour les expressions régulières MongoDB)</p>\n' +
      '<p>Les types de valeurs : Chaîne de caractères entre guillemets doubles, Booléen ("TRUE", "FALSE"), Entier, Virgule flottante, "NULL"</p>\n' +
  ...
  modals: {
    ...
    createSnmpRule: {
      ...
      fields: {
        ...
        moduleMibObjects: {
          vars: 'Champ d\'association des variables SNMP', // TODO
  ...
  parameters: {
    ...
    userInterfaceForm: {
      ...
      fields: {
        ...
        logo: 'Logo',
        infoPopupTimeout: 'Délai d\'affichage pour les popup d\'informations',
        errorPopupTimeout: 'Délai d\'affichage pour les popup d\'erreurs',
        popupTimeoutUnit: 'Unité',
        allowChangeSeverityToInfo: 'Autorise les informations de criticité',
  ...
  scenario: {
    ...
    actions: {
      ...
      [ACTION_TYPES.changeState]: 'Changer l\'état (Change et bloc la criticité)',
  ...
  pageHeaders: {
    ...
    [USERS_PERMISSIONS.technical.exploitation.metaAlarmRule]: {
      title: 'Règles de meta-alarme',
      message: 'Les règles de meta-alarme peuvent être utilisées pour grouper les alarmes par types et critères (relation parent/enfant, intervalle de temps, etc).',
    },
