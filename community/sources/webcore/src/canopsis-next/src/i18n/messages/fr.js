...
export default merge({
  ...
  serviceWeather: {
    ...
    stateCountersTooltips: {
      [SERVICE_WEATHER_STATE_COUNTERS.all]: '{count} alarmes au total',
      [SERVICE_WEATHER_STATE_COUNTERS.active]: '{count} alarmes actives',
      [SERVICE_WEATHER_STATE_COUNTERS.depends]: '{count} dépendances',
      [SERVICE_WEATHER_STATE_COUNTERS.ok]: '{count} état OK',
      [SERVICE_WEATHER_STATE_COUNTERS.minor]: '{count} alarmes mineures',
      [SERVICE_WEATHER_STATE_COUNTERS.major]: '{count} alarmes majeures',
      [SERVICE_WEATHER_STATE_COUNTERS.critical]: '{count} alarmes critiques',
      [SERVICE_WEATHER_STATE_COUNTERS.acked]: '{count} alarmes acquittées',
      [SERVICE_WEATHER_STATE_COUNTERS.unacked]: '{count} non confirmé',
      [SERVICE_WEATHER_STATE_COUNTERS.underPbehavior]: '{count} sous PBh',
      [SERVICE_WEATHER_STATE_COUNTERS.ackedUnderPbehavior]: '{count} accusé de réception sous PBh',
    },
  },
  contextGeneralTable: {
