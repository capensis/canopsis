...
export default {
  ...
  alarmFilteringTime: 'Temps de filtrage d\'alarmes',
  lastFilteringDate: 'Date du dernier filtrage',
  runAlarmFiltering: 'Lancer le filtrage d\'alarmes',
  alarmFilteringInProgress: 'Filtrage d\'alarmes en cours',
  alarmFilteringError: 'Erreur de filtrage d\'alarmes',
  ...
  pbehaviorInfo: 'Infos de comportement périodique',
  pbehaviorType: 'Type de comportement périodique',
  pbehaviorReason: 'Raison de comportement périodique',
