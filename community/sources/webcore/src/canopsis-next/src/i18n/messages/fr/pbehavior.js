...
export default {
  ...
  pbehaviorInfo: 'comportement périodique infos',
  pbehaviorType: 'Type comportement périodique',
  pbehaviorReason: 'Raison comportement périodique',
  pbehaviorName: 'Nom comportement périodique',
