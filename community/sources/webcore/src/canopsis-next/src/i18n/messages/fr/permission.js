...
export default {
  title: {
    ...
    [USER_PERMISSIONS_GROUPS.widgetsMapWidgetsettings]: 'Paramètres du widget Cartogtraphie',
    ...
    [USER_PERMISSIONS.technical.planningReason]: 'Raison de comportement périodique',
