...
export default {
  ...
  instructionStat: {
    ...
    averageAlarmOkTimeout: 'Temps moyen\naprès la fin de la remédiation,\navant l\'état ok',
    averageSuccessfulAllOk: 'Instructions réussies\n(toutes / OK uniquement)',
    averageSuccessfulAll: 'Instructions réussies\n(en résultant tous les états)',
    averageSuccessfulOk: 'Instructions réussies\n(en résultant l\'état OK)',
