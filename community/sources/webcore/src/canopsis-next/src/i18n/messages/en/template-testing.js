...
export default {
  ...
  actionValue: 'Action value - {number}',
  actionAuthor: 'Action author - {number}',
  linkRuleLabel: 'Link rule label - {number}',
  linkRuleUrl: 'Link rule URL - {number}',
  webhookUrl: 'Webhook URL - {number}',
  webhookPayload: 'Webhook payload - {number}',
  webhookHeader: 'Webhook header {header} - {number}',
  noteOutput: 'Note output - {number}',
  widgetContent: 'Widget content',
  widgetTemplate: 'Widget template - {template}',
  columnTemplate: 'Column template - {number}',
  ticketId: 'Ticket ID - {number}',
  ticketUrl: 'Ticket URL - {number}',
  dynamicInfoValue: 'Dynamic info value - {name}',
  ...
  instructionWebhookHeader: 'Instruction webhook header {header} - Step {step}, Operation {operation}',
  ...
  templateVars: {
    ...
    responseFieldFromStep: 'Response field from step',
