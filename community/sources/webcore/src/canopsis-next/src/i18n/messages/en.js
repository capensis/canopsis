...
export default {
  ...
  alarmList: {
    ...
    metrics: {
      ...
      [ALARM_METRIC_PARAMETERS.ackWithoutCancelAlarms]: 'Number of alarms with acks (excluding canceled acks)',
      [ALARM_METRIC_PARAMETERS.ticketAlarms]: 'Number of alarms with tickets created',
      [ALARM_METRIC_PARAMETERS.withoutTicketAlarms]: 'Number of alarms with no tickets created',
  ...
  kpiMetrics: {
    ...
    tooltip: {
      ...
      [ALARM_METRIC_PARAMETERS.totalAlarms]: '{value} alarms total',
      ...
      [ALARM_METRIC_PARAMETERS.ackWithoutCancelAlarms]: '{value} alarms with acks (excluding canceled acks)',
      [ALARM_METRIC_PARAMETERS.ticketAlarms]: '{value} alarms with tickets created',
      [ALARM_METRIC_PARAMETERS.withoutTicketAlarms]: '{value} alarms with not tickets created',
