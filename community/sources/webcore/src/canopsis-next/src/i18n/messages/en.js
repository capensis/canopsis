...
export default merge({
  ...
  serviceWeather: {
    ...
    stateCountersTooltips: {
      [SERVICE_WEATHER_STATE_COUNTERS.all]: '{count} alarms total',
      [SERVICE_WEATHER_STATE_COUNTERS.active]: '{count} active alarms',
      [SERVICE_WEATHER_STATE_COUNTERS.depends]: '{count} dependencies',
      [SERVICE_WEATHER_STATE_COUNTERS.ok]: '{count} OK state',
      [SERVICE_WEATHER_STATE_COUNTERS.minor]: '{count} minor alarms',
      [SERVICE_WEATHER_STATE_COUNTERS.major]: '{count} major alarms',
      [SERVICE_WEATHER_STATE_COUNTERS.critical]: '{count} critical alarms',
      [SERVICE_WEATHER_STATE_COUNTERS.acked]: '{count} alarms acked',
      [SERVICE_WEATHER_STATE_COUNTERS.unacked]: '{count} not acked',
      [SERVICE_WEATHER_STATE_COUNTERS.underPbehavior]: '{count} under PBh',
      [SERVICE_WEATHER_STATE_COUNTERS.ackedUnderPbehavior]: '{count} acked under PBh',
    },
  },
  contextGeneralTable: {
