...
export default {
  ...
  timeline: {
    ...
    steps: {
      ...
      [ALARM_LIST_STEPS.ticketDeclarationRuleProgress]: 'Ticket declaration rule launched by {author} in progress',
      [ALARM_LIST_STEPS.ticketDeclarationRuleCompleted]: 'Ticket declaration rule is complete',
      [ALARM_LIST_STEPS.ticketDeclarationRuleFailed]: 'Ticket declaration rule is failed',
