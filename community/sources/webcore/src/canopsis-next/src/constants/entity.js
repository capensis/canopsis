...
export const EVENT_ENTITY_ICONS_BY_TYPE = {
  ...
  [EVENT_ENTITY_TYPES.declareTicket]: 'local_play',
  [EVENT_ENTITY_TYPES.declareTicketFail]: 'local_play',
  [EVENT_ENTITY_TYPES.webhookStart]: 'local_play',
  [EVENT_ENTITY_TYPES.webhookComplete]: 'local_play',
  [EVENT_ENTITY_TYPES.webhookFail]: 'local_play',
