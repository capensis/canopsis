...
export const ALARM_FIELDS = {
  ...
  state: 'v.state.val',
  maxState: 'v.max_state',
  initialState: 'v.initial_state',
  stateInitiator: 'v.state.initiator',
  status: 'v.status.val',
  ...
  snoozeAuthor: 'v.snooze.a',
  snoozeInitiator: 'v.snooze.initiator',
...
export const ALARM_STEPS_COLORS = {
  ...
  [ALARM_LIST_STEPS.instructionComplete]: COLORS.remediation.executionStatus.completed,
  [ALARM_LIST_STEPS.instructionAbort]: COLORS.remediation.executionStatus.aborted,
  [ALARM_LIST_STEPS.instructionFail]: COLORS.remediation.executionStatus.failed,
  [ALARM_LIST_STEPS.autoInstructionStart]: COLORS.alarmSteps.instruction,
  [ALARM_LIST_STEPS.autoInstructionComplete]: COLORS.remediation.executionStatus.completed,
  [ALARM_LIST_STEPS.autoInstructionFail]: COLORS.remediation.executionStatus.failed,
...
export const ALARM_PATTERN_FIELDS = {
  ...
  stateInitiator: ALARM_FIELDS.stateInitiator,
  ...
  snoozeAuthor: ALARM_FIELDS.snoozeAuthor,
  snoozeInitiator: ALARM_FIELDS.snoozeInitiator,
...
export const ALARM_TEMPLATE_FIELDS = {
  ...
  maxState: `alarm.${ALARM_FIELDS.maxState}`,
  initialState: `alarm.${ALARM_FIELDS.initialState}`,
...
export const ALARM_EXPORT_PDF_FIELDS_TO_ORIGINAL_FIELDS = {
  ...
  [ALARM_EXPORT_PDF_FIELDS.maxState]: 'alarm.v.max_state',
  [ALARM_EXPORT_PDF_FIELDS.initialState]: 'alarm.v.initial_state',
...
export const ALARM_FIELDS_TO_LABELS_KEYS = {
  ...
  [ALARM_FIELDS.stateInitiator]: 'alarm.fields.stateInitiator',
  ...
  [ALARM_FIELDS.snoozeAuthor]: 'alarm.fields.snoozeAuthor',
  [ALARM_FIELDS.snoozeInitiator]: 'alarm.fields.snoozeInitiator',
  ...
  [ALARM_FIELDS.maxState]: 'alarm.fields.maxState',
  [ALARM_FIELDS.initialState]: 'alarm.fields.initialState',
...
export const DEFAULT_ALARM_MORE_INFO_TEMPLATE = '{{!--\n'
