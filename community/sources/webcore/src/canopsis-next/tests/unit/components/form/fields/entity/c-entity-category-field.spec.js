...
describe('c-entity-category-field', () => {
  ...
  it('Check fetch list call', () => {
    ...
    expect(fetchListMock).toHaveBeenCalledWith(expect.any(Object), { params: { limit: MAX_LIMIT } });
  });
  ...
  it('Check creating', async () => {
    ...
    expect(createMock).toHaveBeenCalledWith(expect.any(Object), { data: { name: categoryName } });
