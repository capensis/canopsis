...
*/
Ext.define('canopsis.controller.Comments', {
	extend: 'canopsis.lib.controller.cgrid',

	views: ['Comments.Grid', 'Comments.Form'],
	stores: ['Comments', 'Comments'],
	models: ['Comment', 'Comment'],

	logAuthor: '[controller][Comments]',
	...
	init: function() {
		...
		this.formXtype = 'CommentsForm';
		this.listXtype = 'CommentsGrid';

		this.modelId = 'Comment';
		...
		this.storeDefaultAction = this.getStore('Comments');
