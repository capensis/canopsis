...
DEFAULT_MAX_MATCHED_ITEMS = 10000
...
class UserInterface(object):
    ...
    MAX_MATCHED_ITEMS = 'max_matched_items'

    def __init__(self, _id, app_title=None, footer=None, login_page_description=None, logo=None, language=None,
                 popup_timeout=None, allow_change_severity_to_info=False, max_matched_items=None, *args, **kwargs):
        ...
        self.max_matched_items = max_matched_items
        if self.max_matched_items is None:
            self.max_matched_items = DEFAULT_MAX_MATCHED_ITEMS
    ...
    def to_dict(self):
        ...
        dictionnary = {
            ...
            self.MAX_MATCHED_ITEMS: self.max_matched_items
        }
