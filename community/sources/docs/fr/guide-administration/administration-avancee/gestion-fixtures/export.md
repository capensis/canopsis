...
La liste des paramètres est disponible ici : [schemas_swagger.yaml](https://github.com/capensis/canopsis/blob/release-25.04/community/go-engines-community/lib/api/docs/schemas_swagger.yaml#L2723)
