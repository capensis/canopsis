...
- `regex_map_keys` : permet de récupérer la valeur associée à la première clé d'une map qui correspond à une expression régulière spécifiée.

- `map_as_keys` : utilisé pour vérifier si une map contient une clé spécifiée et retourner un booléen en conséquence.
