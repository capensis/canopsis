...
!!! information
   Cela peut être désactiveé via l'option `disable_state_mapping` mise à `true`
...
3. Ajouter les permissions suivantes : `chown centreon-engine:centreon-engine /usr/share/centreon-broker/lua/bbdo2canopsis.lua`
...
|-------------------|----------------------------------------------------------------|-------------------|------------|-------------------|
| disable_state_mapping | Desactiver les mappings d'états automatiques | false | true/yes/false | 1.0.2 |
| use_instance_name_as_connector_name | Utilise le nom de l'instance du poller centreon au lieu du nom du `connector_name` configuré via le menu de l'output broker Stream Connector | true | true/false | 1.0.2 |
| verbose | Active le mode Debug | true | true/false | all |
