...
L'API Event-Filter permet de consulter, créer et supprimer des règles d'enrichissement. Cette API concerne uniquement les event-filters Go, et non pas les anciens event-filters Python.
