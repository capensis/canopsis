...
## Changements entre Canopsis 22.10.8 23.04.0

### Widgets de métrologie

* https://git.canopsis.net/canopsis/canopsis-pro/-/issues/4228

### Gestionnaire de liens

Jusque Canopsis 22.10, un système de [génération de liens](../../..//guide-administration/linkbuilder) était mis à disposition.  
...
Pour découvrir le fonctionnement du module, RDV sur la [documentation associée](../../../guide-utilisation/menu-exploitation/generateur-liens/).
...
Une [nouvelle option](../../../guide-administration/administration-avancee/modification-canopsis-toml/) fait donc son appariation `ActivateAlarmAfterAutoRemediation`.  
