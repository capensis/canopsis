...
La fonctionnalité "Studio Templates" vous permet de vérifier le rendu de vos [modèles (templates Go)](../../guide-utilisation/templates-go/) avant d'enregistrer une règle ou un widget.  
...
La [documentation](../../guide-utilisation/menu-administration/jetons-authentification-externe/) vous permettra de connaitre tous les éléments de configuration.
