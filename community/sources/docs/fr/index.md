...
=== "Develop"
    ...
    | ------------ |:--------------------------------------------------------:| --- | ---------- | --------- |
    | **develop**  | [📝](notes-de-version/25.10.0.md)  | 🔄 [Changelog](notes-de-version/api/changelog-25.10.0.md)<br>⚠️ [Breaking](notes-de-version/api/breaking-25.10.0.md) | 28/10/2025 | 🧭 [Guide de migration](notes-de-version/migration/migration-25.10.0.md) |
