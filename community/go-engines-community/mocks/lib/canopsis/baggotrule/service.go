...
// Source: git.canopsis.net/canopsis/canopsis-community/community/go-engines-community/lib/canopsis/baggotrule (interfaces: Service)
...
func (m *MockService) Process(arg0 context.Context) ([]types.Alarm, error) {
	m.ctrl.T.Helper()
