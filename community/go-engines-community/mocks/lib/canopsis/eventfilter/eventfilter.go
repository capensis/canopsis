...
//
//	mockgen -destination=../../../mocks/lib/canopsis/eventfilter/eventfilter.go git.canopsis.net/canopsis/canopsis-community/community/go-engines-community/lib/canopsis/eventfilter RuleApplicator,RuleAdapter,RuleApplicatorContainer,ExternalDataGetter,Service,ActionProcessor,FailureService,EventCounter
//
...
// Get mocks base method.
func (m *MockExternalDataGetter) Get(ctx context.Context, ruleID, name string, event *types.Event, parameters eventfilter.ParsedExternalDataParameters, templateParameters eventfilter.Template) (any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, ruleID, name, event, parameters, templateParameters)
	ret0, _ := ret[0].(any)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Get indicates an expected call of Get.
func (mr *MockExternalDataGetterMockRecorder) Get(ctx, ruleID, name, event, parameters, templateParameters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockExternalDataGetter)(nil).Get), ctx, ruleID, name, event, parameters, templateParameters)
}
