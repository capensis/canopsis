...
// Source: git.canopsis.net/canopsis/canopsis-community/community/go-engines-community/lib/canopsis/pbehavior (interfaces: Service,EntityMatcher,ModelProvider,EventManager,ComputedEntityMatcher,Store,EntityTypeResolver,ComputedEntityTypeResolver,TypeComputer)
...
func (m *MockComputedEntityMatcher) GetComputedEntityIDs() ([]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockComputedEntityMatcherMockRecorder) GetComputedEntityIDs() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetComputedEntityIDs", reflect.TypeOf((*MockComputedEntityMatcher)(nil).GetComputedEntityIDs))
}
...
func (m *MockComputedEntityMatcher) Match(arg0 string) ([]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockComputedEntityMatcherMockRecorder) Match(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Match", reflect.TypeOf((*MockComputedEntityMatcher)(nil).Match), arg0)
}
...
// GetComputedRruleStarts mocks base method.
func (m *MockComputedEntityTypeResolver) GetComputedRruleStarts() map[string]pbehavior.RruleStart {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetComputedRruleStarts")
	ret0, _ := ret[0].(map[string]pbehavior.RruleStart)
	return ret0
}

// GetComputedRruleStarts indicates an expected call of GetComputedRruleStarts.
func (mr *MockComputedEntityTypeResolverMockRecorder) GetComputedRruleStarts() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetComputedRruleStarts", reflect.TypeOf((*MockComputedEntityTypeResolver)(nil).GetComputedRruleStarts))
}
