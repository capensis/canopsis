...
// Source: git.canopsis.net/canopsis/canopsis-community/community/go-engines-community/lib/canopsis/pbehavior (interfaces: Service,ModelProvider,EventManager,ComputedEntityMatcher,Store,EntityTypeResolver,ComputedEntityTypeResolver,TypeComputer)
