...
func (m *MockAdapter) UpdateHistoryEventFilterFailure(arg0 context.Context, arg1 time.CpsTime) error {
	m.ctrl.T.Helper()
...
func (m *MockAdapter) UpdateHistoryHealthCheck(arg0 context.Context, arg1 time.CpsTime) error {
	m.ctrl.T.Helper()
...
func (m *MockAdapter) UpdateHistoryJunit(arg0 context.Context, arg1 time.CpsTime) error {
	m.ctrl.T.Helper()
...
func (m *MockAdapter) UpdateHistoryPbehavior(arg0 context.Context, arg1 time.CpsTime) error {
	m.ctrl.T.Helper()
...
func (m *MockAdapter) UpdateHistoryRemediation(arg0 context.Context, arg1 time.CpsTime) error {
	m.ctrl.T.Helper()
...
func (m *MockAdapter) UpdateHistoryWebhook(arg0 context.Context, arg1 time.CpsTime) error {
	m.ctrl.T.Helper()
