...
// Source: git.canopsis.net/canopsis/go-engines/lib/canopsis/entityservice (interfaces: Adapter,CountersCache,Storage)
...
import (
	context "context"
	entityservice "git.canopsis.net/canopsis/go-engines/lib/canopsis/entityservice"
	mongo "git.canopsis.net/canopsis/go-engines/lib/mongo"
