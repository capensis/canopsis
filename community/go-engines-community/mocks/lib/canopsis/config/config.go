...
// Source: git.canopsis.net/canopsis/go-engines/lib/canopsis/config (interfaces: AlarmConfigProvider,TimezoneConfigProvider,RemediationConfigProvider,UserInterfaceConfigProvider,DataStorageConfigProvider)

// Package mock_config is a generated GoMock package.
package mock_config

import (
	config "git.canopsis.net/canopsis/go-engines/lib/canopsis/config"
