...
// Source: git.canopsis.net/canopsis/canopsis-community/community/go-engines-community/lib/canopsis/config (interfaces: AlarmConfigProvider,TimezoneConfigProvider,RemediationConfigProvider,UserInterfaceConfigProvider,DataStorageConfigProvider,MetricsConfigProvider)
...
// MockMetricsConfigProvider is a mock of MetricsConfigProvider interface.
type MockMetricsConfigProvider struct {
	ctrl     *gomock.Controller
	recorder *MockMetricsConfigProviderMockRecorder
}

// MockMetricsConfigProviderMockRecorder is the mock recorder for MockMetricsConfigProvider.
type MockMetricsConfigProviderMockRecorder struct {
	mock *MockMetricsConfigProvider
}

// NewMockMetricsConfigProvider creates a new mock instance.
func NewMockMetricsConfigProvider(ctrl *gomock.Controller) *MockMetricsConfigProvider {
	mock := &MockMetricsConfigProvider{ctrl: ctrl}
	mock.recorder = &MockMetricsConfigProviderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockMetricsConfigProvider) EXPECT() *MockMetricsConfigProviderMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockMetricsConfigProvider) Get() config.MetricsConfig {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get")
	ret0, _ := ret[0].(config.MetricsConfig)
	return ret0
}

// Get indicates an expected call of Get.
func (mr *MockMetricsConfigProviderMockRecorder) Get() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockMetricsConfigProvider)(nil).Get))
}
