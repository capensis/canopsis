...
// Source: git.canopsis.net/canopsis/go-engines/lib/canopsis/engine (interfaces: Engine,Consumer,MessageProcessor,PeriodicalWorker,RPCClient,RPCMessageProcessor)
...
import (
	context "context"
	engine "git.canopsis.net/canopsis/go-engines/lib/canopsis/engine"
...
func (m *MockMessageProcessor) Process(arg0 amqp.Delivery) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockPeriodicalWorker) Work() error {
	m.ctrl.T.Helper()
...
func (mr *MockPeriodicalWorkerMockRecorder) Work() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Work", reflect.TypeOf((*MockPeriodicalWorker)(nil).Work))
}
