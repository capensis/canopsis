...
// Source: git.canopsis.net/canopsis/go-engines/lib/canopsis/context (interfaces: EnrichmentCenter)
...
func (mr *MockEnrichmentCenterMockRecorder) Get(arg0 interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockEnrichmentCenter)(nil).Get), arg0)
}
