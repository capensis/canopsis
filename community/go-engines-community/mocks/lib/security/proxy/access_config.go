...
// Source: ../../../lib/security/proxy/access_config.go
...
func (m *MockAccessConfig) Get(uri, method string) (string, string) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", uri, method)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(string)
	return ret0, ret1
}
...
func (mr *MockAccessConfigMockRecorder) Get(uri, method interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockAccessConfig)(nil).Get), uri, method)
}
