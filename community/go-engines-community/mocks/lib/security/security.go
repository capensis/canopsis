...
// Source: git.canopsis.net/canopsis/canopsis-community/community/go-engines-community/lib/security (interfaces: Enforcer,Provider,HttpProvider,UserProvider,ConfigProvider)
