...
func (f *flags) Parse() {
	...
	flag.StringVar(&f.techPostgresMigrationDirectory, "tech-postgres-migration-directory", DefaultPostgresMigrationsPath, "The directory with Tech Postgres migration scripts")
