...
ALTER TABLE perf_data ALTER COLUMN entity_id type bigint USING entity_id::bigint;
...
ALTER TABLE ticket_number ALTER COLUMN entity_id type bigint USING entity_id::bigint;
