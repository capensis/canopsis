...
-- Register 26.10.x: sequential migrations 1-14 were all applied before
-- the first new-format migration shipped.  No old-sequential migration
-- above 14 exists, so no Force()+Up() replay window is required when
-- upgrading from a 26.10.x database to a later release line.
