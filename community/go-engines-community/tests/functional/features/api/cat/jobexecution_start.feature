Feature: run a job
  ...
  Scenario: given job should start job for operation of instruction
    ...
    """
    {
      ...
      "author": "test-job-execution-start-1-author",
      "enabled": true,
      "steps": [
        {
    ...
    """
    {
      ...
      "operation": "{{ (index (index .lastResponse.steps 1).operations 1).operation_id }}",
      "job": "{{ (index (index (index .lastResponse.steps 1).operations 1).jobs 0).job_id }}"
    }
    """
    Then the response code should be 200
    ...
    """
    {
      ...
      "status": 0,
      "fail_reason": "",
      "payload": "{\"resource\": \"test-job-execution-start-resource-1\",\"entity\": \"test-job-execution-start-resource-1/test-job-execution-start-component\"}",
      "launched_at": 0,
      "completed_at": 0
    }
    """
  ...
  Scenario: given job should not start job for not running operation of instruction
    ...
    """
    {
      ...
      "author": "test-job-execution-start-2-author",
      "enabled": true,
      "steps": [
        {
  ...
  Scenario: given job should not start job for not running instruction
    ...
    """
    {
      ...
      "author": "test-job-execution-start-3-author",
      "enabled": true,
      "steps": [
        {
  ...
  Scenario: given job should start job for operation of instruction
    ...
    """
    {
      ...
      "author": "test-job-execution-start-4-author",
      "enabled": true,
      "steps": [
        {
