Feature: Get remediation metrics
  ...
  Scenario: given get hour request should return metrics
    When I am admin
    When I do GET /api/v4/cat/metrics/remediation?sampling=hour&from={{ parseTimeTz "23-11-2021 00:00" }}&to={{ parseTimeTz "23-11-2021 00:00" }}&instruction=test-instruction-to-remediation-metrics-get
  ...
  Scenario: given get request with empty interval should return metrics with zeros
    When I am admin
    When I do GET /api/v4/cat/metrics/remediation?sampling=day&from={{ parseTimeTz "06-09-2020 00:00" }}&to={{ parseTimeTz "08-09-2020 00:00" }}&instruction=test-instruction-to-remediation-metrics-get
    Then the response code should be 200
