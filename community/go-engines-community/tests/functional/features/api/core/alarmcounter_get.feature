...
#    """
#
#  Scenario: given get counters recent resolved alarms request should return only for recent resolved alarms and opened alarms
#    When I am admin
#    When I do GET /api/v4/alarm-counters?search=test-alarmcounter-get
#    Then the response code should be 200
#    Then the response body should contain:
...
#    """
#
#  Scenario: given get counters for resolved alarms request should return only for resolved alarms
#    When I am admin
#    When I do GET /api/v4/alarm-counters?search=test-alarmcounter-get-resolved&opened=false
#    Then the response code should be 200
#    Then the response body should contain:
#    """
#    {
