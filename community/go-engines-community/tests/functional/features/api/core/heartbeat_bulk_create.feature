    ...
    [
      {
        ...
        "author": "test-heartbeat-to-bulk-create-1-author",
        "pattern": {
      ...
      },
      {
        ...
        "author": "test-heartbeat-to-bulk-create-2-author",
        "pattern": {
    ...
    [
      {
        ...
        "author": "test-heartbeat-to-bulk-create-3-author",
        "pattern": {
    ...
    [
      {
        ...
        "author": "test-heartbeat-to-bulk-create-4-author",
        "pattern": {
    ...
    [
      {
        ...
        "author": "test-heartbeat-to-bulk-create-5-author",
        "pattern": {
    ...
    [
      {
        ...
        "author": "test-heartbeat-to-bulk-create-6-author",
        "pattern": {
      ...
      },
      {
        ...
        "author": "test-heartbeat-to-bulk-create-7-author",
        "pattern": {
      ...
      },
      {
        ...
        "author": "test-heartbeat-to-bulk-create-8-author",
        "pattern": {
