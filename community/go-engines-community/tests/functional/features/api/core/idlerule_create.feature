Feature: Create a idle rule
  ...
  Scenario: given create request with both corporate entity pattern and custom entity pattern should return error
    When I am admin
    When I do POST /api/v4/idle-rules:
    """json
    {
      "name": "test-idle-rule-to-create-7-name",
      "description": "test-idle-rule-to-create-7-description",
      "type": "alarm",
      "alarm_condition": "last_event",
      "enabled": true,
      "priority": 20,
        ...
        [
          {
            ...
            "cond": {
              "type": "eq",
              "value": "test-idle-rule-to-create-7-resource"
            }
          }
        ]
      ],      
      "operation": {
        "type": "snooze",
        "parameters": {
          "output": "test-idle-rule-to-create-7-operation-output",
          "duration": {
            "value": 3,
            "unit": "s"
          }
  ...
  Scenario: given create request with both corporate alarm pattern and custom alarm pattern should return error
    When I am admin
    When I do POST /api/v4/idle-rules:
    """json
    {
      "name": "test-idle-rule-to-create-8-name",
      "description": "test-idle-rule-to-create-8-description",
      "type": "alarm",
      "alarm_condition": "last_event",
      "enabled": true,
      "priority": 20,
        ...
        [
          {
            ...
            "cond": {
              "type": "eq",
              "value": "test-idle-rule-to-create-8-alarm"
            }
          }
        ]
      ],      
      "operation": {
        "type": "snooze",
        "parameters": {
          "output": "test-idle-rule-to-create-8-operation-output",
          "duration": {
            "value": 3,
            "unit": "s"
          }
