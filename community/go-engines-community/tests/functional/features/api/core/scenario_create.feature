Feature: Create a scenario
  ...
  Scenario: given create request should return ok
    ...
    """
    {
      ...
      "author": "test-scenario-to-create-1-author",
      "enabled": true,
      "priority": 10,
      "triggers": ["create"],
      "actions": [
        ...
        },
        {
          ...
          "parameters": {
            ...
            "author": "test-scenario-to-create-1-action-3-author",
            "rrule": "FREQ=DAILY",
  ...
  Scenario: given create request should return ok to get request
    ...
    """
    {
      ...
      "author": "test-scenario-to-create-2-author",
      "enabled": true,
      "priority": 11,
      "triggers": ["create"],
      "actions": [
        {
          ...
          "type": "snooze",
          "parameters": {
            "author": "test-scenario-to-create-2-action-1-author",
        ...
        },
        {
          ...
          "parameters": {
            ...
            "author": "test-scenario-to-create-2-action-3-author",
            "rrule": "FREQ=DAILY",
            "reason": "test-reason-to-edit-scenario",
            "type": "test-type-to-edit-scenario",
            "start_on_trigger": true,
  ...
  Scenario: given create delay request should return ok
    ...
    """
    {
      ...
      "author": "test-scenario-to-create-3-author",
      "enabled": true,
      "priority": 12,
      "triggers": ["create"],
      "delay": {
  ...
  Scenario: given create request with already exists name should return error
    ...
    """
    {
      ...
      "author": "test-scenario-to-create-4-author",
      "enabled": true,
      "priority": 13,
      "triggers": ["create"],
      "actions": [
