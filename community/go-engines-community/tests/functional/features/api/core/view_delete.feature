Feature: Delete a view
  ...
  Scenario: given delete request should delete view
    When I am admin
    When I do DELETE /api/v4/views/test-view-to-delete
    Then the response code should be 204
    When I do GET /api/v4/views/test-view-to-delete
    Then the response code should be 403
    When I do GET /api/v4/permissions?search=test-view-to-delete
