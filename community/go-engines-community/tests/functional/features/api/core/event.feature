Feature: send an event
  ...
  Scenario: POST a valid event should add ma_parents
    When I am admin
    When I do POST /api/v4/event:
    """json
    {
  ...
  Scenario: POST a valid event should add ma_children with ref_rk
    When I am admin
    When I do POST /api/v4/event:
    """json
    {
      "connector": "engine2",
      "connector_name": "correlation2",
      "source_type": "resource",
      "event_type": "check",
      "component": "some",
      "ref_rk": "test-alarm-with-parents-and-children-resource/test-alarm-with-parents-and-children-component",
      "state": 1,
      "resource": "some"
    }
    """
  ...
  Scenario: POST a valid event should add ma_children and ma_parents without ref_rk
    When I am admin
    When I do POST /api/v4/event:
    """json
    {
      ...
      "source_type": "resource",
      "event_type": "check",
      "component": "test-alarm-with-parents-and-children-component",
      "state": 1,
      "resource": "test-alarm-with-parents-and-children-resource"
    }
    """
    Then the response code should be 200
    Then the response body should contain:
