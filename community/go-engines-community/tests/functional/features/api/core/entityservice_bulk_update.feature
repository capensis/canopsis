Feature: Bulk update entityservices
  I need to be able to bulk update entityservices
  Only admin should be able to bulk update entityservices

  Scenario: given bulk update request and no auth should not allow access
    When I do PUT /api/v4/bulk/entityservices
  ...
  Scenario: given bulk update request should return multistatus and should be handled independently
    ...
    [
      ...
      [],
      {
        ...
        "infos": [
          {
            "description": "test-entityservice-to-bulk-update-2-info-1-description",
            "name": "test-entityservice-to-bulk-update-2-info-1-name",
            "value": "test-entityservice-to-bulk-update-2-info-1-value"
          },
          {
            "description": "test-entityservice-to-bulk-update-2-info-2-description",
            "name": "test-entityservice-to-bulk-update-2-info-2-name",
            "value": false
          },
          {
            "description": "test-entityservice-to-bulk-update-2-info-3-description",
            "name": "test-entityservice-to-bulk-update-2-info-3-name",
            "value": 1022
          },
          {
            "description": "test-entityservice-to-bulk-update-2-info-4-description",
            "name": "test-entityservice-to-bulk-update-2-info-4-name",
            "value": 10.45
          },
          {
            "description": "test-entityservice-to-bulk-update-2-info-5-description",
            "name": "test-entityservice-to-bulk-update-2-info-5-name",
            "value": null
          },
          {
            "description": "test-entityservice-to-bulk-update-2-info-6-description",
            "name": "test-entityservice-to-bulk-update-2-info-6-name",
    ...
    """
    When I do GET /api/v4/entityservices/test-entityservice-to-bulk-update-1
    ...
    """json
    {
      ...
      "infos": {
        ...
        "test-entityservice-to-bulk-update-1-info-2-name": {
          "description": "test-entityservice-to-bulk-update-1-info-2-description",
          "name": "test-entityservice-to-bulk-update-1-info-2-name",
          "value": false
        },
        "test-entityservice-to-bulk-update-1-info-3-name": {
          "description": "test-entityservice-to-bulk-update-1-info-3-description",
          "name": "test-entityservice-to-bulk-update-1-info-3-name",
          "value": 1022
        },
        "test-entityservice-to-bulk-update-1-info-4-name": {
          "description": "test-entityservice-to-bulk-update-1-info-4-description",
          "name": "test-entityservice-to-bulk-update-1-info-4-name",
          "value": 10.45
        },
        "test-entityservice-to-bulk-update-1-info-5-name": {
          "description": "test-entityservice-to-bulk-update-1-info-5-description",
          "name": "test-entityservice-to-bulk-update-1-info-5-name",
          "value": null
        },
        "test-entityservice-to-bulk-update-1-info-6-name": {
          "description": "test-entityservice-to-bulk-update-1-info-6-description",
          "name": "test-entityservice-to-bulk-update-1-info-6-name",
          "value": ["test-entityservice-to-bulk-update-1-info-6-value", false, 1022, 10.45, null]
        }
    ...
    """
    When I do GET /api/v4/entityservices/test-entityservice-to-bulk-update-2
    Then the response code should be 200
    Then the response body should contain:
    """json
    {
      ...
      "infos": {
        ...
        "test-entityservice-to-bulk-update-2-info-2-name": {
          "description": "test-entityservice-to-bulk-update-2-info-2-description",
          "name": "test-entityservice-to-bulk-update-2-info-2-name",
          "value": false
        },
        "test-entityservice-to-bulk-update-2-info-3-name": {
          "description": "test-entityservice-to-bulk-update-2-info-3-description",
          "name": "test-entityservice-to-bulk-update-2-info-3-name",
          "value": 1022
        },
        "test-entityservice-to-bulk-update-2-info-4-name": {
          "description": "test-entityservice-to-bulk-update-2-info-4-description",
          "name": "test-entityservice-to-bulk-update-2-info-4-name",
          "value": 10.45
        },
        "test-entityservice-to-bulk-update-2-info-5-name": {
          "description": "test-entityservice-to-bulk-update-2-info-5-description",
          "name": "test-entityservice-to-bulk-update-2-info-5-name",
          "value": null
        },
        "test-entityservice-to-bulk-update-2-info-6-name": {
          "description": "test-entityservice-to-bulk-update-2-info-6-description",
          "name": "test-entityservice-to-bulk-update-2-info-6-name",
          "value": ["test-entityservice-to-bulk-update-2-info-6-value", false, 1022, 10.45, null]
        }
