Feature: Create an resolve rule
  ...
  Scenario: given create request with both corporate entity pattern and custom entity pattern should return error
    ...
    """json
    {
      "name": "test-resolve-rule-to-create-6-name",
      "description": "test-resolve-rule-to-create-6-description",
      "corporate_entity_pattern": "test-pattern-to-rule-edit-2",
      "entity_pattern": [
        [
          {
  ...
  Scenario: given create request with both corporate alarm pattern and custom alarm pattern should return error
    ...
    """json
    {
      "name": "test-resolve-rule-to-create-7-name",
      "description": "test-resolve-rule-to-create-7-description",
      "corporate_alarm_pattern": "test-pattern-to-rule-edit-1",
      "alarm_pattern": [
        [
          {
