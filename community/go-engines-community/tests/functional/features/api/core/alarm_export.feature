Feature: Export alarms
  ...
  Scenario: given export request should return alarms
    ...
    test-alarm-to-export-1,test-resource-to-alarm-export-1/test-component-default,,test-connector-default,test-connector-default-name,test-component-default,test-resource-to-alarm-export-1,critical,ongoing,09 Aug 2020 05:12 CEST,10 Aug 2020 06:17 CEST,test-dynamic-infos-to-alarm-export-info-name: test-dynamic-infos-to-alarm-export-info-value,test-dynamic-infos-to-alarm-export-info-value,,test-resource-to-alarm-export-1-info-1: test-resource-to-alarm-export-1-info-1-value,test-resource-to-alarm-export-1-info-1-value,,test-link-rule-to-alarm-export-link-label: http://test-link-rule-to-alarm-export-link-url.com?ids[]=test-resource-to-alarm-export-1/test-component-default&,test-link-rule-to-alarm-export-link-label: http://test-link-rule-to-alarm-export-link-url.com?ids[]=test-resource-to-alarm-export-1/test-component-default&,
