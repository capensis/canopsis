Feature: Update widget grid positions
  ...
  @concurrent
  Scenario: given update request for private widgets should update positions
    When I am admin
    When I do POST /api/v4/widgets:
    """json
    {
      "title": "test-private-widget-to-update-grid-position-1-1-title",
      "type": "test-private-widget-to-update-grid-position-1-1-type",
      "tab": "test-private-tab-to-private-widget-update-grid-position-1",
      "grid_parameters": {
        "desktop": {"x": 0, "y": 0}
      }
    }
    ...
    """json
    {
      "title": "test-private-widget-to-update-grid-position-1-2-title",
      "type": "test-private-widget-to-update-grid-position-1-2-type",
      "tab": "test-private-tab-to-private-widget-update-grid-position-1",
      "grid_parameters": {
        "desktop": {"x": 1, "y": 0}
      }
    ...
    """json
    {
      "title": "test-private-widget-to-update-grid-position-1-3-title",
      "type": "test-private-widget-to-update-grid-position-1-3-type",
      "tab": "test-private-tab-to-private-widget-update-grid-position-1",
      "grid_parameters": {
        "desktop": {"x": 0, "y": 1}
      }
    ...
    When I save response widget3={{ .lastResponse._id }}
    # Test created positions
    When I do GET /api/v4/views/test-private-view-to-private-widget-update-grid-position-1
    Then the response code should be 200
    Then the response body should contain:
    """json
    {
