Feature: execute action on trigger
  ...
  Scenario: given scenario and check event should update alarm
    ...
    """
    {
      ...
      "author": "test-scenario-action-1-author",
      "enabled": true,
      "priority": 20,
      "triggers": ["create"],
      "actions": [
        {
          ...
          "type": "assocticket",
          "parameters": {
            "author": "test-author-action-1-{{ `{{ .Entity.ID }}` }}",
      ...
      "data": [
        {
          "v": {
            "ticket": {
              "_t": "assocticket",
              "a": "test-author-action-1-test-resource-action-1/test-component-action-1",
  ...
  Scenario: given delayed scenario and check event should update alarm
    ...
    """
    {
      ...
      "author": "test-scenario-action-2-author",
      "enabled": true,
      "priority": 21,
      "triggers": ["create"],
      "delay": {
      ...
      "actions": [
        {
          ...
          "type": "assocticket",
          "parameters": {
            "author": "test-author-action-2-{{ `{{ .Entity.ID }}` }}",
      ...
      "data": [
        {
          "v": {
            "ticket": {
              "_t": "assocticket",
              "a": "test-author-action-2-test-resource-action-2/test-component-action-2",
  ...
  Scenario: given scenario with emit trigger and check event should update alarm
    ...
    """
    {
      ...
      "author": "test-scenario-action-3-author-1",
      "enabled": true,
      "priority": 22,
      "triggers": ["create"],
      "actions": [
        {
          ...
          "type": "assocticket",
          "parameters": {
            "author": "test-author-action-3-{{ `{{ .Entity.ID }}` }}",
    ...
    """
    {
      ...
      "author": "test-scenario-action-3-author-2",
      "enabled": true,
      "priority": 23,
      ...
      "data": [
        {
          "v": {
            "ticket": {
              "_t": "assocticket",
              "a": "test-author-action-3-test-resource-action-3/test-component-action-3",
