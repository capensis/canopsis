Feature: execute action on trigger
      ...
      "actions": [
        {
          ...
          "parameters": {
            "request": {
              ...
              "payload": "{\"name\":\"{{ `{{ .Entity.ID }}` }}\",\"author\":\"test-scenario-action-webhook-1\",\"enabled\":true,\"priority\":41,\"triggers\":[\"create\"],\"actions\":[{\"alarm_patterns\":[{\"_id\":\"test-scenario-action-webhook-1-alarm\"}],\"type\":\"ack\",\"drop_scenario_if_not_matched\":false,\"emit_trigger\":false}]}"
            },
            "declare_ticket": {
  ...
  Scenario: given scenario and check event should emit declare ticket trigger
    ...
    """
    {
      ...
      "author": "test-scenario-action-webhook-2-1-author",
      "enabled": true,
      "priority": 31,
      "triggers": ["create"],
      "actions": [
        {
          ...
          "parameters": {
            "request": {
              ...
              "headers": {"Content-Type": "application/json"},
              "payload": "{\"name\":\"test-scenario-action-webhook-2\",\"author\":\"test-scenario-action-webhook-2\",\"enabled\":true,\"priority\":42,\"triggers\":[\"create\"],\"actions\":[{\"alarm_patterns\":[{\"_id\":\"test-scenario-action-webhook-2-alarm\"}],\"type\":\"ack\",\"drop_scenario_if_not_matched\":false,\"emit_trigger\":false}]}"
            },
            "declare_ticket": {
              "empty_response": false,
              "is_regexp": false,
    ...
    """
    {
      ...
      "author": "test-scenario-action-webhook-2-2-author",
      "enabled": true,
      "priority": 32,
  ...
  Scenario: given scenario and ack resources event should update resource alarms
    ...
    """
    {
      ...
      "author": "test-scenario-action-webhook-3-author",
      "enabled": true,
      "priority": 33,
      "triggers": ["ack"],
      "actions": [
        {
          ...
          "parameters": {
            "request": {
              ...
              "headers": {"Content-Type": "application/json"},
              "payload": "{\"name\":\"test-scenario-action-webhook-3\",\"author\":\"test-scenario-action-webhook-3\",\"enabled\":true,\"priority\":43,\"triggers\":[\"create\"],\"actions\":[{\"alarm_patterns\":[{\"_id\":\"test-scenario-action-webhook-3-alarm\"}],\"type\":\"ack\",\"drop_scenario_if_not_matched\":false,\"emit_trigger\":false}]}"
            },
            "declare_ticket": {
              "empty_response": false,
              "is_regexp": false,
  ...
  Scenario: given webhook scenario to test response and header templates
    ...
    """
    {
      ...
      "author": "test-scenario-action-webhook-4-author",
      "enabled": true,
      "priority": 34,
      "triggers": ["create"],
      "actions": [
        ...
        },
        {
          ...
          "parameters": {
            "request": {
              ...
              "payload": "{\"name\":\"test-scenario-action-webhook-4-webhook\",\"author\":\"{{ `{{index .Response \"icon_name\"}}` }}\",\"enabled\":true,\"priority\":44,\"triggers\":[\"create\"],\"actions\":[{\"alarm_patterns\":[{\"_id\":\"{{ `{{index .Response \"_id\"}}` }}\"}],\"type\":\"ack\",\"drop_scenario_if_not_matched\":false,\"emit_trigger\":false}]}"
            }
          },
          "drop_scenario_if_not_matched": false,
          "emit_trigger": false
  ...
  Scenario: given scenario and declareticket event should update alarm
    ...
    """
    {
      ...
      "author": "test-scenario-action-webhook-5-author",
      "enabled": true,
      "priority": 35,
      ...
      "actions": [
        {
          ...
          "parameters": {
            "request": {
              ...
              "headers": {"Content-Type": "application/json"},
              "payload": "{\"name\":\"{{ `{{ .Entity.ID }}` }}\",\"author\":\"test-scenario-action-webhook-5\",\"enabled\":true,\"priority\":45,\"triggers\":[\"create\"],\"actions\":[{\"alarm_patterns\":[{\"_id\":\"test-scenario-action-webhook-5-alarm\"}],\"type\":\"ack\",\"drop_scenario_if_not_matched\":false,\"emit_trigger\":false}]}"
            },
            "declare_ticket": {
              "empty_response": false,
              "is_regexp": false,
