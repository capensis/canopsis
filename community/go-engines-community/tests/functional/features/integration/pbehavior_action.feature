Feature: no execute action when entity is inactive
  ...
  Scenario: given action and maintenance pbehavior should not update alarm
    ...
    """
    {
      ...
      "author": "test-scenario-pbehavior-action-1-author",
      "enabled": true,
      "priority": 71,
      "triggers": ["stateinc"],
      ...
      "actions": [
        {
          ...
          "type": "ack",
          "parameters": {"output": "test ack", "author": "root"},
  ...
  Scenario: given delayed action and maintenance pbehavior should update alarm after pbehavior
    ...
    """
    {
      ...
      "author": "test-scenario-pbehavior-action-2-author",
      "enabled": true,
      "priority": 72,
      "triggers": ["create"],
      "delay": {
  ...
  Scenario: given pbehavior action should create pbehavior and update new alarm
    ...
    """
    {
      ...
      "author": "test-scenario-pbehavior-action-3-author",
      "enabled": true,
      "priority": 73,
      "triggers": ["create"],
      "actions": [
  ...
  Scenario: given pbehavior action with start on trigger should create pbehavior
    ...
    """
    {
      ...
      "author": "test-scenario-pbehavior-action-4-author",
      "enabled": true,
      "priority": 74,
      "triggers": ["create"],
      "actions": [
  ...
  Scenario: given pbehavior action should create pbehavior and update old alarm
    ...
    """
    {
      ...
      "author": "test-scenario-pbehavior-action-5-author",
      "enabled": true,
      "priority": 75,
      "triggers": ["stateinc"],
      "actions": [
