Feature: scenarios should be triggered by remediation triggers
  ...
  @concurrent
  Scenario: given scenario with webhook should be triggered only if no instructions started
    Given I am admin
    When I do POST /api/v4/scenarios:
    """json
    {
            ...
            [
              {
                ...
                "cond": {
                  "type": "is_one_of",
                  "value": [
                    "test-resource-action-remediation-triggers-second-5-1",
                    "test-resource-action-remediation-triggers-second-5-2"
                  ]
                }
              }
            ]
    ...
    [
      {
        "connector": "test-connector-action-remediation-triggers-second-5",
        "connector_name": "test-connector-name-action-remediation-triggers-second-5",
        "source_type": "resource",
        "event_type": "check",
        "component": "test-component-action-remediation-triggers-second-5",
        "resource": "test-resource-action-remediation-triggers-second-5-1",
        "state": 1,
        "output": "test output"
      },
      {
        ...
        "event_type": "check",
        "component": "test-component-action-remediation-triggers-second-5",
        "resource": "test-resource-action-remediation-triggers-second-5-2",
        "state": 1,
        "output": "test output"
      }
    ]
    ...
    """
    When I do GET /api/v4/alarms?search=test-resource-action-remediation-triggers-second-5&sort_by=v.resource&sort=asc until response code is 200 and body contains:
    """json
    {
      "data": [
        {
