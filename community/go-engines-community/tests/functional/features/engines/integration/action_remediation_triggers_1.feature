Feature: scenarios should be triggered by remediation triggers
  ...
  @concurrent
  Scenario: given scenario should be triggered by autoinstructionresultok trigger
    Given I am admin
    When I do POST /api/v4/scenarios:
    """json
    {
      ...
      "actions": [
        {
            ...
            [
              {
                ...
                "cond": {
                  "type": "eq",
                  "value": "test-resource-action-remediation-triggers-9/test-component-action-remediation-triggers-9"
                }
              }
            ]
          ],
          "type": "ack",
          "parameters": {
            "output": "test-resource-action-remediation-triggers-9-ack"
          },
          "drop_scenario_if_not_matched": false,
          "emit_trigger": false
        }
    ...
    """json
    {
      "connector": "test-connector-action-remediation-triggers-9",
      "connector_name": "test-connector-name-action-remediation-triggers-9",
      "source_type": "resource",
      "event_type": "check",
      "component": "test-component-action-remediation-triggers-9",
      "resource": "test-resource-action-remediation-triggers-9",
      "state": 1,
      "output": "test output"
    }
    """
    ...
    """
    When I do GET /api/v4/alarms?search=test-resource-action-remediation-triggers-9 until response code is 200 and body contains:
    """json
    {
      "data": [
        {
