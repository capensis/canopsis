Feature: no update service when entity is inactive
  ...
  Scenario: given entity service and maintenance pbehavior should not update service alarm on create with pbhenter event
    ...
    """json
    {
      ...
      "output_template": "Depends: {{ `{{ .Depends }}` }}; All: {{ `{{.All}}` }}; Active: {{ `{{.Active}}` }}; Acked: {{ `{{.Acknowledged}}` }}; NotAcked: {{ `{{.NotAcknowledged}}` }}; NotAckedPbh: {{ `{{.NotAcknowledgedUnderPbh}}` }}; StateCritical: {{ `{{.State.Critical}}` }}; StateMajor: {{ `{{.State.Major}}` }}; StateMinor: {{ `{{.State.Minor}}` }}; StateOk: {{ `{{.State.Ok}}` }}; Pbehaviors: {{ `{{.PbehaviorCounters}}` }}; UnderPbehavior: {{ `{{.UnderPbehavior}}` }};",
      "impact_level": 1,
      "enabled": true,
      "entity_pattern": [
        [
            ...
            "data": [
              {
                "_t": "stateinc",
                "a": "service.service",
                "m": "Depends: 1; All: 1; Active: 1; Acked: 0; NotAcked: 1; NotAckedPbh: 0; StateCritical: 1; StateMajor: 0; StateMinor: 0; StateOk: 0; Pbehaviors: map[]; UnderPbehavior: 0;",
                "val": 3
              },
              {
                "_t": "statusinc",
              ...
              },
              {
                "_t": "statedec",
                "a": "service.service",
                "m": "Depends: 1; All: 1; Active: 0; Acked: 0; NotAcked: 0; NotAckedPbh: 1; StateCritical: 0; StateMajor: 0; StateMinor: 0; StateOk: 1; Pbehaviors: map[test-maintenance-type-to-engine:1]; UnderPbehavior: 1;",
                "val": 0
              },
              {
                "_t": "statusdec",
          ...
          "steps": {
            "data": [
              ...
              },
              {
                "_t": "stateinc",
                "a": "service.service",
                "m": "Depends: 1; All: 1; Active: 1; Acked: 0; NotAcked: 1; NotAckedPbh: 0; StateCritical: 1; StateMajor: 0; StateMinor: 0; StateOk: 0; Pbehaviors: map[test-maintenance-type-to-engine:0]; UnderPbehavior: 0;",
                "val": 3
              },
              {
                "_t": "statusinc",
          ...
          "steps": {
            "data": [
              ...
              },
              {
                "_t": "statedec",
                "a": "service.service",
                "m": "Depends: 1; All: 1; Active: 0; Acked: 0; NotAcked: 0; NotAckedPbh: 1; StateCritical: 0; StateMajor: 0; StateMinor: 0; StateOk: 1; Pbehaviors: map[test-inactive-type-to-engine:1]; UnderPbehavior: 1;",
                "val": 0
              },
              {
                "_t": "statusdec",
              ...
              },
              {
                "_t": "stateinc",
                "a": "service.service",
                "m": "Depends: 2; All: 2; Active: 1; Acked: 0; NotAcked: 1; NotAckedPbh: 1; StateCritical: 0; StateMajor: 1; StateMinor: 0; StateOk: 1; Pbehaviors: map[test-inactive-type-to-engine:0 test-maintenance-type-to-engine:1]; UnderPbehavior: 1;",
                "val": 2
              },
              {
                "_t": "statusinc",
