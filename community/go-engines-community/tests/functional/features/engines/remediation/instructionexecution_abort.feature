Feature: abort a instruction execution
        ...
        [
          {
            ...
            "cond": {
              "type": "eq",
              "value": "test-resource-remediation-instruction-execution-abort-2"
            }
          }
        ]
      ],
  ...
  Scenario: given paused instruction should cancel it on ok change state action
    ...
    """
    {
      "name": "test-scenario-remediation-instruction-execution-abort-4-name",
      "priority": 10067,
      "enabled": true,
      "triggers": [
        {
      ...
      "actions": [
        {
          ...
          "type": "changestate",
          "parameters": {
            "output": "test-output-remediation-instruction-execution-abort-4",
            "state": 0
          },
