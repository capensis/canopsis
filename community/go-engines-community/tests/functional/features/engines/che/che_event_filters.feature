Feature: modify event on event filter
  ...
  Scenario: given check event and drop event filter with time interval should drop event in that interval
    ...
    """json
    {
      ...
      "event_pattern":[[
        ...
        },
        {
          ...
          "cond": {
            "type": "eq",
            "value": "test-component-che-event-filters-16"
          }
        }
      ]],
    ...
    """json
    {
      ...
      "source_type": "resource",
      "event_type": "check",
      "component": "test-component-che-event-filters-16",
      "resource": "test-resource-che-event-filters-16-1",
      "state": 2,
      "output": "test-output-che-event-filters-16"
    }
    """
    When I wait the end of event processing
    When I do GET /api/v4/alarms?search=che-event-filters-16
    Then the response code should be 200
    Then the response body should contain:
    """json
    {
      "data": [
        {
          "entity": {
            "_id": "test-resource-che-event-filters-16-1/test-component-che-event-filters-16"
          }
        }
      ],
      "meta": {
    ...
    """json
    {
      ...
      "event_type": "check",
      "component": "test-component-che-event-filters-16",
      "resource": "test-resource-che-event-filters-16-2",
      "state": 2,
      "output": "test-output-che-event-filters-16"
    }
    """
    ...
    """json
    {
      ...
      "event_type": "check",
      "component": "test-component-che-event-filters-16",
      "resource": "test-resource-che-event-filters-16-3",
      "state": 2,
      "output": "test-output-che-event-filters-16"
    }
    """
    When I wait the end of event processing
    When I do GET /api/v4/alarms?search=che-event-filters-16&sort_by=t&sort=asc
    Then the response code should be 200
    Then the response body should contain:
    """json
    {
      "data": [
        ...
        {
          "entity": {
            "_id": "test-resource-che-event-filters-16-3/test-component-che-event-filters-16"
          }
        }
      ],
      "meta": {
  ...
  Scenario: given check event and drop event filter with time interval should drop event by rrule
    ...
    """json
    {
      ...
      "event_pattern":[[
        ...
        },
        {
          ...
          "cond": {
            "type": "eq",
            "value": "test-component-che-event-filters-17"
          }
        }
      ]],
    ...
    """json
    {
      ...
      "source_type": "resource",
      "event_type": "check",
      "component": "test-component-che-event-filters-17",
      "resource": "test-resource-che-event-filters-17-1",
      "state": 2,
      "output": "test-output-che-event-filters-17"
    }
    """
    When I wait the end of event processing
    When I do GET /api/v4/alarms?search=che-event-filters-17
    Then the response code should be 200
    Then the response body should contain:
    """json
    {
  ...
  Scenario: given check event and drop event filter with time interval should drop event by rrule with count
    ...
    """json
    {
      "data": [
        {
          "entity": {
            "_id": "test-resource-che-event-filters-18-2/test-component-che-event-filters-18"
          }
        }
      ],
      "meta": {
  ...
  Scenario: given check event and drop event filter with time interval shouldn't drop event because of exdate
    ...
    """json
    {
      "data": [
        {
          "entity": {
            "_id": "test-resource-che-event-filters-19-1/test-component-che-event-filters-19"
          }
        }
      ],
      "meta": {
    ...
    """json
    {
      ...
      "event_type": "check",
      "component": "test-component-che-event-filters-19",
      "resource": "test-resource-che-event-filters-19-2",
      "state": 2,
      "output": "test-output-che-event-filters-19"
    }
    """
