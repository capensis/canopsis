Feature: update service on event
  ...
  @concurrent
  Scenario: given entity service and entity which changes its service on alarm creation should update counters properly
    Given I am admin
    ...
    """json
    {
        ...
        [
          {
            ...
            "cond": {
              "type": "regexp",
              "value": "test-resource-service-third-3"
            }
          },
          {
            "field": "event_type",
      ...
      "description": "test-eventfilter-service-third-3-description",
      "enabled": true
    }
    """
    Then the response code should be 201
    ...
    """json
    {
      "name": "test-entityservice-service-third-3-name-1",
        ...
        [
          {
            ...
            "cond": {
              "type": "eq",
              "value": "test-client-service-third-3-1"
            }
          }
        ]
      ],
    ...
    [
      {
        "connector": "test-connector-service-third-3",
        "connector_name": "test-connector-name-service-third-3",
        "source_type": "resource",
        "event_type": "check",
        "component": "test-component-service-third-3",
        "resource": "test-resource-service-third-3-1",
        "client": "test-client-service-third-3-1",
        "state": 0,
        "output": "test-output-service-third-3"
      },
      {
        "connector": "test-connector-service-third-3",
        "connector_name": "test-connector-name-service-third-3",
        ...
        "event_type": "check",
        "component": "test-component-service-third-3",
        "resource": "test-resource-service-third-3-2",
        "client": "test-client-service-third-3-1",
        "state": 1,
        "output": "test-output-service-third-3"
      }
      ...
      "data": [
        {
          "v": {
            ...
            "connector": "service",
            "connector_name": "service",
            "output": "Depends: 2; All: 1; Active: 1; Acknowledged: 0; NotAcknowledged: 1; AcknowledgedUnderPbh: 0; StateCritical: 0; StateMajor: 0; StateMinor: 1; StateOk: 0; Pbehaviors: map[]; UnderPbehavior: 0;"
          }
        }
      ],
      "meta": {
    ...
    [
      {
        ...
        "component": "test-component-service-third-3",
        "resource": "test-resource-service-third-3-1",
        "client": "test-client-service-third-3-2",
        "state": 1,
        "output": "test-output-service-third-3"
      }
    ]
      ...
      "data": [
        {
          "v": {
            ...
            "connector": "service",
            "connector_name": "service",
            "output": "Depends: 1; All: 1; Active: 1; Acknowledged: 0; NotAcknowledged: 1; AcknowledgedUnderPbh: 0; StateCritical: 0; StateMajor: 0; StateMinor: 1; StateOk: 0; Pbehaviors: map[]; UnderPbehavior: 0;"
          }
        }
      ],
      "meta": {
