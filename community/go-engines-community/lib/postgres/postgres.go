...
func NewPool(ctx context.Context, retryCount int, minRetryTimeout time.Duration) (Pool, error) {
	...
	return NewPoolByConnStr(ctx, connStr, retryCount, minRetryTimeout)
}
...
func NewPoolByConnStr(ctx context.Context, connStr string, retryCount int, minRetryTimeout time.Duration) (Pool, error) {
