...
func TestUpdateIntervals(t *testing.T) {
	dataSets := map[string]struct {
		...
		rrule                     string
		now                       time.Time
		expectedResolvedStart     libtime.CpsTime
		expectedResolvedStop      libtime.CpsTime
		expectedNextResolvedStart *libtime.CpsTime
		expectedNextResolvedStop  *libtime.CpsTime
	}{
		"simple case, before the interval, shouldn't be updated": {
			ef: Rule{
				Start:             &libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
				Stop:              &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
				ResolvedStart:     &libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
				ResolvedStop:      &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
				NextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 8, 0, 0, 0, 0, time.UTC)},
				NextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 9, 0, 0, 0, 0, time.UTC)},
			},
			rrule:                     "FREQ=DAILY;INTERVAL=7",
			now:                       time.Date(2021, 12, 31, 0, 0, 0, 0, time.UTC),
			expectedResolvedStart:     libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
			expectedResolvedStop:      libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 8, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 9, 0, 0, 0, 0, time.UTC)},
		},
		...
		"simple case, after the interval, should be updated": {
			...
			expectedResolvedStart:     libtime.CpsTime{Time: time.Date(2022, 1, 8, 0, 0, 0, 0, time.UTC)},
			expectedResolvedStop:      libtime.CpsTime{Time: time.Date(2022, 1, 9, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 15, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 16, 0, 0, 0, 0, time.UTC)},
		},
		...
		"before the interval, but next interval is not calculated, cross intervals, should be updated": {
			ef: Rule{
				Start:         &libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
				Stop:          &libtime.CpsTime{Time: time.Date(2022, 1, 3, 0, 0, 0, 0, time.UTC)},
				ResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
				ResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 3, 0, 0, 0, 0, time.UTC)},
			},
			rrule:                     "FREQ=DAILY",
			now:                       time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC),
			expectedResolvedStart:     libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
			expectedResolvedStop:      libtime.CpsTime{Time: time.Date(2022, 1, 3, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 4, 0, 0, 0, 0, time.UTC)},
		},
		"in the interval, cross intervals, shouldn't be updated": {
			ef: Rule{
				...
				ResolvedStart:     &libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
				ResolvedStop:      &libtime.CpsTime{Time: time.Date(2022, 1, 3, 0, 0, 0, 0, time.UTC)},
				NextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
				NextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 4, 0, 0, 0, 0, time.UTC)},
			},
			rrule:                     "FREQ=DAILY",
		...
		"after the interval, cross intervals, should be updated": {
			...
			expectedResolvedStart:     libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
			expectedResolvedStop:      libtime.CpsTime{Time: time.Date(2022, 1, 4, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 3, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 5, 0, 0, 0, 0, time.UTC)},
		},
		"after the interval, with counts, next interval should be nil, because of exceeded count, should be updated": {
			ef: Rule{
				Start:             &libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
				Stop:              &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
				ResolvedStart:     &libtime.CpsTime{Time: time.Date(2022, 1, 5, 0, 0, 0, 0, time.UTC)},
				ResolvedStop:      &libtime.CpsTime{Time: time.Date(2022, 1, 6, 0, 0, 0, 0, time.UTC)},
				NextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 6, 0, 0, 0, 0, time.UTC)},
				NextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 7, 0, 0, 0, 0, time.UTC)},
			},
			rrule:                     "FREQ=DAILY;COUNT=5",
			now:                       time.Date(2022, 1, 6, 0, 0, 0, 1, time.UTC),
			expectedResolvedStart:     libtime.CpsTime{Time: time.Date(2022, 1, 6, 0, 0, 0, 0, time.UTC)},
			expectedResolvedStop:      libtime.CpsTime{Time: time.Date(2022, 1, 7, 0, 0, 0, 0, time.UTC)},
		...
		"after the interval, with counts, next interval should be nil, because of exceeded count, shouldn't be updated": {
			ef: Rule{
				Start:             &libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
				Stop:              &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
				ResolvedStart:     &libtime.CpsTime{Time: time.Date(2022, 1, 6, 0, 0, 0, 0, time.UTC)},
				ResolvedStop:      &libtime.CpsTime{Time: time.Date(2022, 1, 7, 0, 0, 0, 0, time.UTC)},
				NextResolvedStart: nil,
				NextResolvedStop:  nil,
			},
			rrule:                     "FREQ=DAILY;COUNT=5",
		...
		"after the interval, long cross intervals with counts, should be updated": {
			ef: Rule{
				Start:             &libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)},
				Stop:              &libtime.CpsTime{Time: time.Date(2022, 1, 5, 0, 0, 0, 0, time.UTC)},
				ResolvedStart:     &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
				ResolvedStop:      &libtime.CpsTime{Time: time.Date(2022, 1, 6, 0, 0, 0, 0, time.UTC)},
				NextResolvedStart: nil,
				NextResolvedStop:  nil,
			},
			rrule:                     "FREQ=DAILY;COUNT=5",
			now:                       time.Date(2022, 1, 7, 0, 0, 0, 1, time.UTC),
			expectedResolvedStart:     libtime.CpsTime{Time: time.Date(2022, 1, 4, 0, 0, 0, 0, time.UTC)},
			expectedResolvedStop:      libtime.CpsTime{Time: time.Date(2022, 1, 8, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 5, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 9, 0, 0, 0, 0, time.UTC)},
		},
		"test with old intervals, they should be be updated": {
			ef: Rule{
				Start:         &libtime.CpsTime{Time: time.Date(2021, 1, 1, 0, 0, 0, 0, time.UTC)},
				Stop:          &libtime.CpsTime{Time: time.Date(2021, 1, 2, 0, 0, 0, 0, time.UTC)},
				ResolvedStart: &libtime.CpsTime{Time: time.Date(2021, 1, 1, 0, 0, 0, 0, time.UTC)},
				ResolvedStop:  &libtime.CpsTime{Time: time.Date(2021, 1, 2, 0, 0, 0, 0, time.UTC)},
			},
			rrule:                     "FREQ=DAILY",
			...
			expectedResolvedStop:      libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
			expectedNextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 3, 0, 0, 0, 0, time.UTC)},
		},
		"weird test": {
			ef: Rule{
				Start:         &libtime.CpsTime{Time: time.Date(2022, 1, 1, 9, 0, 0, 0, time.UTC)},
				Stop:          &libtime.CpsTime{Time: time.Date(2022, 1, 1, 9, 20, 0, 0, time.UTC)},
				ResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 1, 9, 0, 0, 0, time.UTC)},
				ResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 1, 9, 20, 0, 0, time.UTC)},
			},
			rrule:                     "FREQ=MINUTELY;INTERVAL=20;BYHOUR=9,10,11,12,13,14,15,16",
			now:                       time.Date(2022, 1, 4, 10, 30, 0, 0, time.UTC),
			expectedResolvedStart:     libtime.CpsTime{Time: time.Date(2022, 1, 4, 10, 20, 0, 0, time.UTC)},
			expectedResolvedStop:      libtime.CpsTime{Time: time.Date(2022, 1, 4, 10, 40, 0, 0, time.UTC)},
			expectedNextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 4, 10, 40, 0, 0, time.UTC)},
			expectedNextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 4, 11, 0, 0, 0, time.UTC)},
		},
	}
...
func BenchmarkCalculateRRuleAllCalculated(b *testing.B) {
	ef := &Rule{
		...
		ResolvedStop:      &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
		NextResolvedStart: &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)},
		NextResolvedStop:  &libtime.CpsTime{Time: time.Date(2022, 1, 3, 0, 0, 0, 0, time.UTC)},
	}
	...
	for i := 0; i < b.N; i++ {
		ef.ResolvedStart = &libtime.CpsTime{Time: time.Date(2022, 1, 1, 0, 0, 0, 0, time.UTC)}
		ef.ResolvedStop = &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)}
		ef.NextResolvedStart = &libtime.CpsTime{Time: time.Date(2022, 1, 2, 0, 0, 0, 0, time.UTC)}
		ef.NextResolvedStop = &libtime.CpsTime{Time: time.Date(2022, 1, 3, 0, 0, 0, 0, time.UTC)}
...
func getBenchmarkData(start, stop time.Time, rruleString string) (*Rule, *rrule.RRule, error) {
	ef := Rule{
		Start: &libtime.CpsTime{Time: start},
		Stop:  &libtime.CpsTime{Time: stop},
	}
