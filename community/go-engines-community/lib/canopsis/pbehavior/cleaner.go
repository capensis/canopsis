...
type Cleaner interface {
	Clean(ctx context.Context, before libtime.CpsTime, limit int64) (int64, error)
}
...
func (c *cleaner) Clean(ctx context.Context, before libtime.CpsTime, limit int64) (int64, error) {
