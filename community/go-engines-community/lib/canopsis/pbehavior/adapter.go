...
type Adapter interface {
	UpdateLastAlarmDate(ctx context.Context, id string, time libtime.CpsTime) error
}
...
func (a *adapter) UpdateLastAlarmDate(ctx context.Context, id string, time libtime.CpsTime) error {
