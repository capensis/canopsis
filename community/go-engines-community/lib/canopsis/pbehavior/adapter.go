...
type Adapter interface {
	UpdateLastAlarmDate(ctx context.Context, id string, time types.CpsTime) error
}
...
func (a *adapter) UpdateLastAlarmDate(ctx context.Context, id string, time types.CpsTime) error {
