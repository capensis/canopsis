...
func TestGetDateSpans(t *testing.T) {
	for suiteName, suitData := range dataSetsForGetDateSpans() {
		for caseName, data := range suitData.cases {
			output, err := pbehavior.GetDateSpans(suitData.event, data.viewSpan)
...
func dataSetsForGetDateSpans() map[string]intervalSuitDataSet {
	return map[string]intervalSuitDataSet{
		"Given single event": {
			event: pbehavior.NewEvent(genTime("01-06-2020 09:00"), genTime("01-06-2020 18:00")),
			cases: map[string]intervalCaseDataSet{
				"and current month span Should return 1 span": {
					viewSpan: timespan.New(genTime("01-06-2020 00:00"), genTime("30-06-2020 00:00")),
					expected: []timespan.Span{
						timespan.New(genTime("01-06-2020 00:00"), genTime("01-06-2020 00:00")),
					},
				},
				"and next month span Should return 0 spans": {
					viewSpan: timespan.New(genTime("01-07-2020 00:00"), genTime("31-07-2020 00:00")),
					expected: []timespan.Span{},
				},
				"and prev month span Should return 0 spans": {
					viewSpan: timespan.New(genTime("01-05-2020 00:00"), genTime("31-05-2020 00:00")),
					expected: []timespan.Span{},
				},
			},
		},
		"Given workday event": {
			...
			cases: map[string]intervalCaseDataSet{
				"and current month span Should return n spans where n is count of weeks": {
					viewSpan: timespan.New(genTime("01-06-2020 00:00"), genTime("30-06-2020 00:00")),
					expected: []timespan.Span{
						timespan.New(genTime("01-06-2020 00:00"), genTime("05-06-2020 00:00")),
						timespan.New(genTime("08-06-2020 00:00"), genTime("12-06-2020 00:00")),
						timespan.New(genTime("15-06-2020 00:00"), genTime("19-06-2020 00:00")),
						timespan.New(genTime("22-06-2020 00:00"), genTime("26-06-2020 00:00")),
						timespan.New(genTime("29-06-2020 00:00"), genTime("30-06-2020 00:00")),
					},
				},
				"and next month span Should return n spans where n is count of weeks": {
					viewSpan: timespan.New(genTime("01-07-2020 00:00"), genTime("31-07-2020 00:00")),
					expected: []timespan.Span{
						timespan.New(genTime("01-07-2020 00:00"), genTime("03-07-2020 00:00")),
						timespan.New(genTime("06-07-2020 00:00"), genTime("10-07-2020 00:00")),
						timespan.New(genTime("13-07-2020 00:00"), genTime("17-07-2020 00:00")),
						timespan.New(genTime("20-07-2020 00:00"), genTime("24-07-2020 00:00")),
						timespan.New(genTime("27-07-2020 00:00"), genTime("31-07-2020 00:00")),
					},
				},
				"and prev month span Should return 0 spans": {
					viewSpan: timespan.New(genTime("01-05-2020 00:00"), genTime("31-05-2020 00:00")),
		...
		"Given workday event for 3 weeks": {
			event: pbehavior.NewRecEvent(
				genTime("01-06-2020 09:00"),
				genTime("01-06-2020 18:00"),
				&rrule.ROption{
			...
			cases: map[string]intervalCaseDataSet{
				"and current month span Should return 3 spans": {
					viewSpan: timespan.New(genTime("01-06-2020 00:00"), genTime("30-06-2020 00:00")),
					expected: []timespan.Span{
						timespan.New(genTime("01-06-2020 00:00"), genTime("05-06-2020 00:00")),
						timespan.New(genTime("08-06-2020 00:00"), genTime("12-06-2020 00:00")),
		...
		"Given midnight/midday event": {
			...
			cases: map[string]intervalCaseDataSet{
				"and current month span Should return current month span": {
					viewSpan: timespan.New(genTime("01-06-2020 00:00"), genTime("30-06-2020 00:00")),
					expected: []timespan.Span{
						timespan.New(genTime("01-06-2020 00:00"), genTime("30-06-2020 00:00")),
					},
				},
			},
		},
		"Given getTimeSpansForSingleEvent in 2 days event": {
			...
			cases: map[string]intervalCaseDataSet{
				"and current month span Should return n/2 spans where n is day count of current month": {
					viewSpan: timespan.New(genTime("01-06-2020 00:00"), genTime("30-06-2020 00:00")),
					expected: []timespan.Span{
						timespan.New(genTime("01-06-2020 00:00"), genTime("01-06-2020 00:00")),
						timespan.New(genTime("03-06-2020 00:00"), genTime("03-06-2020 00:00")),
						timespan.New(genTime("05-06-2020 00:00"), genTime("05-06-2020 00:00")),
						timespan.New(genTime("07-06-2020 00:00"), genTime("07-06-2020 00:00")),
						timespan.New(genTime("09-06-2020 00:00"), genTime("09-06-2020 00:00")),
						timespan.New(genTime("11-06-2020 00:00"), genTime("11-06-2020 00:00")),
						timespan.New(genTime("13-06-2020 00:00"), genTime("13-06-2020 00:00")),
						timespan.New(genTime("15-06-2020 00:00"), genTime("15-06-2020 00:00")),
						timespan.New(genTime("17-06-2020 00:00"), genTime("17-06-2020 00:00")),
						timespan.New(genTime("19-06-2020 00:00"), genTime("19-06-2020 00:00")),
						timespan.New(genTime("21-06-2020 00:00"), genTime("21-06-2020 00:00")),
						timespan.New(genTime("23-06-2020 00:00"), genTime("23-06-2020 00:00")),
						timespan.New(genTime("25-06-2020 00:00"), genTime("25-06-2020 00:00")),
						timespan.New(genTime("27-06-2020 00:00"), genTime("27-06-2020 00:00")),
						timespan.New(genTime("29-06-2020 00:00"), genTime("29-06-2020 00:00")),
					},
				},
			},
		},
		"Given midday to next midday getTimeSpansForSingleEvent in 3 days event": {
			...
			cases: map[string]intervalCaseDataSet{
				"and current month span Should return n/3 spans where n is day count of current month": {
					viewSpan: timespan.New(genTime("01-06-2020 00:00"), genTime("30-06-2020 00:00")),
					expected: []timespan.Span{
						timespan.New(genTime("01-06-2020 00:00"), genTime("02-06-2020 00:00")),
						timespan.New(genTime("04-06-2020 00:00"), genTime("05-06-2020 00:00")),
						timespan.New(genTime("07-06-2020 00:00"), genTime("08-06-2020 00:00")),
						timespan.New(genTime("10-06-2020 00:00"), genTime("11-06-2020 00:00")),
						timespan.New(genTime("13-06-2020 00:00"), genTime("14-06-2020 00:00")),
						timespan.New(genTime("16-06-2020 00:00"), genTime("17-06-2020 00:00")),
						timespan.New(genTime("19-06-2020 00:00"), genTime("20-06-2020 00:00")),
						timespan.New(genTime("22-06-2020 00:00"), genTime("23-06-2020 00:00")),
						timespan.New(genTime("25-06-2020 00:00"), genTime("26-06-2020 00:00")),
						timespan.New(genTime("28-06-2020 00:00"), genTime("29-06-2020 00:00")),
					},
				},
			},
		},
		...
		"Given 2 days getTimeSpansForSingleEvent in 4 days event": {
			event: pbehavior.NewRecEvent(
				genTime("01-06-2020 12:00"),
				genTime("03-06-2020 12:00"),
				&rrule.ROption{
			...
			cases: map[string]intervalCaseDataSet{
				"and current month span Should return n/4 spans where n is day count of current month": {
					viewSpan: timespan.New(genTime("01-06-2020 00:00"), genTime("30-06-2020 00:00")),
					expected: []timespan.Span{
						timespan.New(genTime("01-06-2020 00:00"), genTime("03-06-2020 00:00")),
						timespan.New(genTime("05-06-2020 00:00"), genTime("07-06-2020 00:00")),
						timespan.New(genTime("09-06-2020 00:00"), genTime("11-06-2020 00:00")),
						timespan.New(genTime("13-06-2020 00:00"), genTime("15-06-2020 00:00")),
						timespan.New(genTime("17-06-2020 00:00"), genTime("19-06-2020 00:00")),
						timespan.New(genTime("21-06-2020 00:00"), genTime("23-06-2020 00:00")),
						timespan.New(genTime("25-06-2020 00:00"), genTime("27-06-2020 00:00")),
						timespan.New(genTime("29-06-2020 00:00"), genTime("30-06-2020 00:00")),
					},
				},
			},
