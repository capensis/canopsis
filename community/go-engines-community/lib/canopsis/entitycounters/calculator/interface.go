...
type ComponentCountersCalculator interface {
	...
	CalculateCounters(ctx context.Context, entity *types.Entity, alarm *types.Alarm, alarmChange types.AlarmChange) (bool, bool, int, error)
...
type EntityServiceCountersCalculator interface {
	...
	CalculateCounters(ctx context.Context, entity *types.Entity, alarm *types.Alarm, alarmChange types.AlarmChange) (bool, map[string]entitycounters.UpdatedServicesInfo, error)
