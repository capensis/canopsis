...
func (a *Alarm) PartialUpdateCancel(timestamp CpsTime, author, output, role,
	initiator string, cfg config.CanopsisConf) error {
...
func (a *Alarm) PartialUpdateState(timestamp CpsTime, state CpsNumber, output string, cfg config.CanopsisConf) error {
...
func (a *Alarm) PartialUpdateStatus(timestamp CpsTime, output string, cfg config.CanopsisConf) error {
	currentStatus := a.CurrentStatus(cfg)
	newStatus := a.ComputeStatus(cfg)
