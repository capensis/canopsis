...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes11(out *jwriter.Writer, in AlarmValue) {
	...
	}
	{
		...
		if in.Steps == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v93, v94 := range in.Steps {
				if v93 > 0 {
					out.RawByte(',')
				}
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes13(out, v94)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.LongOutputHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v95, v96 := range in.LongOutputHistory {
				if v95 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Children == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v99, v100 := range in.Children {
				if v99 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.UnlinkedParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v101, v102 := range in.UnlinkedParents {
				if v101 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v103First := true
			for v103Name, v103Value := range in.Infos {
				if v103First {
					v103First = false
				} else {
					out.RawByte(',')
