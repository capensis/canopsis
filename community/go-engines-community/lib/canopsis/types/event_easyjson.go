...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes(out *jwriter.Writer, in Event) {
	...
	if len(in.TicketData) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v12First := true
			for v12Name, v12Value := range in.TicketData {
				if v12First {
					v12First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.MetaAlarmParents == nil {
			...
			if *in.MetaAlarmParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
				...
				out.RawByte('[')
				for v14, v15 := range *in.MetaAlarmParents {
					if v14 > 0 {
						out.RawByte(',')
					}
	...
	}
	{
		...
		if in.MetaAlarmChildren == nil {
			...
			if *in.MetaAlarmChildren == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
				...
				out.RawByte('[')
				for v16, v17 := range *in.MetaAlarmChildren {
					if v16 > 0 {
						out.RawByte(',')
					}
	...
	if len(in.AddedToServices) != 0 {
		...
		{
			out.RawByte('[')
			for v18, v19 := range in.AddedToServices {
				if v18 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.RemovedFromServices) != 0 {
		...
		{
			out.RawByte('[')
			for v20, v21 := range in.RemovedFromServices {
				if v20 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "tickets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v44 AlarmStep
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, &v44)
		...
		case "steps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v45 AlarmStep
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, &v45)
	...
	if len(in.Tickets) != 0 {
		...
		}
		{
			...
			for v52, v53 := range in.Tickets {
				...
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, v53)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Steps == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v54, v55 := range in.Steps {
				...
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, v55)
			}
			out.RawByte(']')
		}
	}
