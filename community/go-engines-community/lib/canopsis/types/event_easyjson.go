		...
		case "impact":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Impacts = append(out.Impacts, v26)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "depends":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Depends = append(out.Depends, v27)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "steps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Steps = append(out.Steps, v47)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "long_output_history":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LongOutputHistory = append(out.LongOutputHistory, v48)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Parents = append(out.Parents, v49)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Children = append(out.Children, v50)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v51 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v51 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v52 interface{}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(out *jwriter.Writer, in AlarmTicket) {
	...
	}
	{
		...
		if in.Data == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v66First := true
			for v66Name, v66Value := range in.Data {
				if v66First {
					v66First = false
				} else {
					out.RawByte(',')
