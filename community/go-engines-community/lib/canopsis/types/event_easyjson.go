	...
	for !in.IsDelim('}') {
		...
		case "struct_m":
			if in.IsNull() {
				...
				if out.StructuredMessage == nil {
					if !in.IsDelim(']') {
						out.StructuredMessage = make([]StructuredMessage, 0, 2)
					} else {
						out.StructuredMessage = []StructuredMessage{}
					}
				} else {
					out.StructuredMessage = (out.StructuredMessage)[:0]
				}
				for !in.IsDelim(']') {
					var v1 StructuredMessage
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes3(in, &v1)
					out.StructuredMessage = append(out.StructuredMessage, v1)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "ma_parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MetaAlarmParents = append(out.MetaAlarmParents, v5)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ma_children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MetaAlarmChildren = append(out.MetaAlarmChildren, v6)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ma_tags":
			if in.IsNull() {
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes5(in, out.MetaAlarmTags)
			}
		case "ma_infos":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					var v7 CorrelationRuleInfo
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(in, &v7)
					out.MetaAlarmInfos = append(out.MetaAlarmInfos, v7)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "pbehavior_info":
			easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(in, &out.PbehaviorInfo)
		case "initiator":
			if in.IsNull() {
				in.Skip()
			} else {
		...
		case "added_to_services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AddedToServices = append(out.AddedToServices, v8)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "removed_from_services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RemovedFromServices = append(out.RemovedFromServices, v9)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes(out *jwriter.Writer, in Event) {
	...
	if len(in.StructuredMessage) != 0 {
		...
		{
			out.RawByte('[')
			for v11, v12 := range in.StructuredMessage {
				if v11 > 0 {
					out.RawByte(',')
				}
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes3(out, v12)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.ExtraInfos) != 0 {
		const prefix string = ",\"extra\":"
		out.RawString(prefix)
		{
			out.RawByte('{')
			v13First := true
			for v13Name, v13Value := range in.ExtraInfos {
				if v13First {
					v13First = false
				} else {
					out.RawByte(',')
	...
	if len(in.ImportTags) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v15First := true
			for v15Name, v15Value := range in.ImportTags {
				if v15First {
					v15First = false
				} else {
					out.RawByte(',')
	...
	if len(in.MetaAlarmParents) != 0 {
		...
		{
			out.RawByte('[')
			for v16, v17 := range in.MetaAlarmParents {
				if v16 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.MetaAlarmChildren) != 0 {
		...
		{
			out.RawByte('[')
			for v18, v19 := range in.MetaAlarmChildren {
				if v18 > 0 {
					out.RawByte(',')
				}
	...
	if in.MetaAlarmTags != nil {
		...
		out.RawString(prefix)
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes5(out, *in.MetaAlarmTags)
	}
	if len(in.MetaAlarmInfos) != 0 {
		...
		{
			out.RawByte('[')
			for v20, v21 := range in.MetaAlarmInfos {
				if v20 > 0 {
					out.RawByte(',')
				}
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(out, v21)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		out.RawString(prefix)
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(out, in.PbehaviorInfo)
	}
	{
	...
	if len(in.AddedToServices) != 0 {
		...
		{
			out.RawByte('[')
			for v22, v23 := range in.AddedToServices {
				if v22 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.RemovedFromServices) != 0 {
		...
		{
			out.RawByte('[')
			for v24, v25 := range in.RemovedFromServices {
				if v24 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.TicketData) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v26First := true
			for v26Name, v26Value := range in.TicketData {
				if v26First {
					v26First = false
				} else {
					out.RawByte(',')
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(in *jlexer.Lexer, out *PbehaviorInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(out *jwriter.Writer, in PbehaviorInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(in *jlexer.Lexer, out *CorrelationRuleInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(out *jwriter.Writer, in CorrelationRuleInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes5(in *jlexer.Lexer, out *CorrelationRuleTags) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "filter_by_label":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterByLabel = append(out.FilterByLabel, v27)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes5(out *jwriter.Writer, in CorrelationRuleTags) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CopyFromChildren {
	...
	if len(in.FilterByLabel) != 0 {
		...
		{
			out.RawByte('[')
			for v28, v29 := range in.FilterByLabel {
				if v28 > 0 {
					out.RawByte(',')
				}
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes3(in *jlexer.Lexer, out *StructuredMessage) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes3(out *jwriter.Writer, in StructuredMessage) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "enable_history":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.EnableHistory = append(out.EnableHistory, v30)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v31 Info
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, &v31)
					(out.Infos)[key] = v31
					in.WantComma()
				}
				in.Delim('}')
		...
		case "component_infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v32 Info
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, &v32)
					(out.ComponentInfos)[key] = v32
					in.WantComma()
				}
				in.Delim('}')
			}
		...
		case "services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Services = append(out.Services, v33)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "inherited_services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.InheritedServices = append(out.InheritedServices, v34)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "services_to_add":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ServicesToAdd = append(out.ServicesToAdd, v35)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "services_to_remove":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ServicesToRemove = append(out.ServicesToRemove, v36)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "imtags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ImportTags = append(out.ImportTags, v37)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "state_info":
			if in.IsNull() {
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(in, out.StateInfo)
			}
		...
		case "comments":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v38 EntityComment
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(in, &v38)
					out.Comments = append(out.Comments, v38)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "last_comment":
			if in.IsNull() {
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(in, out.LastComment)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes2(out *jwriter.Writer, in Entity) {
	...
	}
	{
		...
		if in.EnableHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v39, v40 := range in.EnableHistory {
				if v39 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v41First := true
			for v41Name, v41Value := range in.Infos {
				if v41First {
					v41First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, v41Value)
			}
			out.RawByte('}')
		}
	}
	if len(in.ComponentInfos) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v42First := true
			for v42Name, v42Value := range in.ComponentInfos {
				if v42First {
					v42First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, v42Value)
			}
			out.RawByte('}')
		}
	}
	...
	if len(in.InheritedServices) != 0 {
		...
		{
			out.RawByte('[')
			for v45, v46 := range in.InheritedServices {
				if v45 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.ServicesToAdd) != 0 {
		...
		{
			out.RawByte('[')
			for v47, v48 := range in.ServicesToAdd {
				if v47 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.ServicesToRemove) != 0 {
		...
		{
			out.RawByte('[')
			for v49, v50 := range in.ServicesToRemove {
				if v49 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.ImportTags) != 0 {
		...
		{
			out.RawByte('[')
			for v51, v52 := range in.ImportTags {
				if v51 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.StateInfo == nil {
			...
			easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(out, *in.StateInfo)
		}
	}
	...
	if len(in.Comments) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v53, v54 := range in.Comments {
				...
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out, v54)
			}
			out.RawByte(']')
		}
	}
	if in.LastComment != nil {
		...
		out.RawString(prefix)
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out, *in.LastComment)
	}
	out.RawByte('}')
}
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(in *jlexer.Lexer, out *EntityComment) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "a":
			if in.IsNull() {
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes11(in, out.Author)
			}
		case "m":
			if in.IsNull() {
				in.Skip()
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out *jwriter.Writer, in EntityComment) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Author == nil {
			...
			easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes11(out, *in.Author)
		}
	}
	{
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes11(in *jlexer.Lexer, out *Author) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes11(out *jwriter.Writer, in Author) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(in *jlexer.Lexer, out *StateInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "inherited_pattern":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v55 []pattern.FieldCondition
					if in.IsNull() {
						in.Skip()
						v55 = nil
					} else {
						...
						if v55 == nil {
							if !in.IsDelim(']') {
								v55 = make([]pattern.FieldCondition, 0, 0)
							} else {
								v55 = []pattern.FieldCondition{}
							}
						} else {
							v55 = (v55)[:0]
						}
						for !in.IsDelim(']') {
							var v56 pattern.FieldCondition
							easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisPattern(in, &v56)
							v55 = append(v55, v56)
							in.WantComma()
						}
						in.Delim(']')
					}
					out.InheritedPattern = append(out.InheritedPattern, v55)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(out *jwriter.Writer, in StateInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if len(in.InheritedPattern) != 0 {
		...
		{
			out.RawByte('[')
			for v57, v58 := range in.InheritedPattern {
				if v57 > 0 {
					out.RawByte(',')
				}
				if v58 == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					...
					for v59, v60 := range v58 {
						...
						easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisPattern(out, v60)
					}
					out.RawByte(']')
				}
			}
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in *jlexer.Lexer, out *Info) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out *jwriter.Writer, in Info) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "etags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ExternalTags = append(out.ExternalTags, v62)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "itags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.InternalTags = append(out.InternalTags, v63)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "imtags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ImportTags = append(out.ImportTags, v64)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "filter_ctags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterChildrenTagsByLabel = append(out.FilterChildrenTagsByLabel, v65)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "cinfos":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.EntityInfosFromChildren = append(out.EntityInfosFromChildren, v66)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "v":
			easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes12(in, &out.Value)
		case "kpi_assigned_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.KpiAssignedInstructions = append(out.KpiAssignedInstructions, v67)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "kpi_executed_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.KpiExecutedInstructions = append(out.KpiExecutedInstructions, v68)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "kpi_assigned_auto_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.KpiAssignedAutoInstructions = append(out.KpiAssignedAutoInstructions, v69)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "kpi_executed_auto_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.KpiExecutedAutoInstructions = append(out.KpiExecutedAutoInstructions, v70)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "meta_alarm_inactive_delay":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v71 MetaAlarmInactiveDelay
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes13(in, &v71)
					out.MetaAlarmInactiveDelay = append(out.MetaAlarmInactiveDelay, v71)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes1(out *jwriter.Writer, in Alarm) {
	...
	if len(in.ExternalTags) != 0 {
		...
		{
			out.RawByte('[')
			for v74, v75 := range in.ExternalTags {
				if v74 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.InternalTags) != 0 {
		...
		{
			out.RawByte('[')
			for v76, v77 := range in.InternalTags {
				if v76 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.ImportTags) != 0 {
		...
		{
			out.RawByte('[')
			for v78, v79 := range in.ImportTags {
				if v78 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.FilterChildrenTagsByLabel) != 0 {
		...
		{
			out.RawByte('[')
			for v80, v81 := range in.FilterChildrenTagsByLabel {
				if v80 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.EntityInfosFromChildren) != 0 {
		...
		{
			out.RawByte('[')
			for v82, v83 := range in.EntityInfosFromChildren {
				if v82 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		out.RawString(prefix)
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes12(out, in.Value)
	}
	if len(in.KpiAssignedInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v84, v85 := range in.KpiAssignedInstructions {
				if v84 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiExecutedInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v86, v87 := range in.KpiExecutedInstructions {
				if v86 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiAssignedAutoInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v88, v89 := range in.KpiAssignedAutoInstructions {
				if v88 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiExecutedAutoInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v90, v91 := range in.KpiExecutedAutoInstructions {
				if v90 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.MetaAlarmInactiveDelay) != 0 {
		...
		{
			out.RawByte('[')
			for v92, v93 := range in.MetaAlarmInactiveDelay {
				if v92 > 0 {
					out.RawByte(',')
				}
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes13(in *jlexer.Lexer, out *MetaAlarmInactiveDelay) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes13(out *jwriter.Writer, in MetaAlarmInactiveDelay) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes12(in *jlexer.Lexer, out *AlarmValue) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "ack":
			if in.IsNull() {
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.ACK)
			}
		case "canceled":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.Canceled)
			}
		case "snooze":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.Snooze)
			}
		case "state":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.State)
			}
		case "status":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.Status)
			}
		case "comments":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					var v94 AlarmStep
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, &v94)
					out.Comments = append(out.Comments, v94)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "last_comment":
			if in.IsNull() {
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.LastComment)
			}
		case "change_state":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.ChangeState)
			}
		case "tickets":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					var v95 AlarmStep
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, &v95)
					out.Tickets = append(out.Tickets, v95)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ticket":
			if in.IsNull() {
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.Ticket)
			}
		case "failed_ticket":
			if in.IsNull() {
				in.Skip()
				...
				if out.FailedTicket == nil {
					out.FailedTicket = new(AlarmStep)
				}
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.FailedTicket)
			}
		case "steps":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					var v96 AlarmStep
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, &v96)
					out.Steps = append(out.Steps, v96)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "long_output_history":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LongOutputHistory = append(out.LongOutputHistory, v97)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Parents = append(out.Parents, v98)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Children = append(out.Children, v99)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "unlinked_parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.UnlinkedParents = append(out.UnlinkedParents, v100)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v101 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v101 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v102 interface{}
							if m, ok := v102.(easyjson.Unmarshaler); ok {
								m.UnmarshalEasyJSON(in)
							} else if m, ok := v102.(json.Unmarshaler); ok {
								_ = m.UnmarshalJSON(in.Raw())
							} else {
								v102 = in.Interface()
							}
		...
		case "close_delay":
			if in.IsNull() {
				...
				easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, out.CloseDelay)
			}
		case "max_state":
			if in.IsNull() {
				in.Skip()
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes12(out *jwriter.Writer, in AlarmValue) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ACK != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.ACK)
	}
	if in.Canceled != nil {
		...
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.Canceled)
	}
	if in.Snooze != nil {
		...
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.Snooze)
	}
	if in.State != nil {
		const prefix string = ",\"state\":"
		if first {
		...
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.State)
	}
	if in.Status != nil {
		const prefix string = ",\"status\":"
		if first {
		...
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.Status)
	}
	if len(in.Comments) != 0 {
		const prefix string = ",\"comments\":"
		if first {
		...
		{
			out.RawByte('[')
			for v103, v104 := range in.Comments {
				if v103 > 0 {
					out.RawByte(',')
				}
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, v104)
			}
			out.RawByte(']')
		}
	}
	if in.LastComment != nil {
		...
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.LastComment)
	}
	if in.ChangeState != nil {
		...
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.ChangeState)
	}
	if len(in.Tickets) != 0 {
		...
		{
			out.RawByte('[')
			for v105, v106 := range in.Tickets {
				if v105 > 0 {
					out.RawByte(',')
				}
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, v106)
			}
			out.RawByte(']')
		}
	}
	if in.Ticket != nil {
		...
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.Ticket)
	}
	if in.FailedTicket != nil {
		...
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.FailedTicket)
	}
	{
		...
		if in.Steps == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v107, v108 := range in.Steps {
				if v107 > 0 {
					out.RawByte(',')
				}
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, v108)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.LongOutputHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v109, v110 := range in.LongOutputHistory {
				if v109 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Parents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v111, v112 := range in.Parents {
				if v111 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Children == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v113, v114 := range in.Children {
				if v113 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.UnlinkedParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v115, v116 := range in.UnlinkedParents {
				if v115 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v117First := true
			for v117Name, v117Value := range in.Infos {
				if v117First {
					v117First = false
				} else {
					out.RawByte(',')
	...
	if in.CloseDelay != nil {
		const prefix string = ",\"close_delay\":"
		out.RawString(prefix)
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, *in.CloseDelay)
	}
	if in.MaxState != 0 {
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in *jlexer.Lexer, out *AlarmStep) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "statecounter":
			easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes15(in, &out.StateCounter)
		...
		case "struct_m":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v119 StructuredMessage
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes3(in, &v119)
					out.StructuredMessage = append(out.StructuredMessage, v119)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out *jwriter.Writer, in AlarmStep) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		out.RawString(prefix)
		easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes15(out, in.StateCounter)
	}
	...
	if len(in.StructuredMessage) != 0 {
		...
		{
			out.RawByte('[')
			for v121, v122 := range in.StructuredMessage {
				if v121 > 0 {
					out.RawByte(',')
				}
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes3(out, v122)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.TicketData) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v123First := true
			for v123Name, v123Value := range in.TicketData {
				if v123First {
					v123First = false
				} else {
					out.RawByte(',')
...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes15(in *jlexer.Lexer, out *CropCounter) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes15(out *jwriter.Writer, in CropCounter) {
	out.RawByte('{')
	first := true
	_ = first
	{
