...
func easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes(in *jlexer.Lexer, out *Event) {
	...
	for !in.IsDelim('}') {
		...
		case "ma_related_parents":
			if in.IsNull() {
				in.Skip()
				out.MetaAlarmRelatedParents = nil
			} else {
				in.Delim('[')
				if out.MetaAlarmRelatedParents == nil {
					if !in.IsDelim(']') {
						out.MetaAlarmRelatedParents = make([]string, 0, 4)
					} else {
						out.MetaAlarmRelatedParents = []string{}
					}
				} else {
					out.MetaAlarmRelatedParents = (out.MetaAlarmRelatedParents)[:0]
				}
				for !in.IsDelim(']') {
					var v3 string
					v3 = string(in.String())
					out.MetaAlarmRelatedParents = append(out.MetaAlarmRelatedParents, v3)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes(out *jwriter.Writer, in Event) {
	...
	{
		const prefix string = ",\"ma_related_parents\":"
		out.RawString(prefix)
		if in.MetaAlarmRelatedParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
			for v11, v12 := range in.MetaAlarmRelatedParents {
				if v11 > 0 {
					out.RawByte(',')
				}
		...
		case "impact":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Impacts = append(out.Impacts, v21)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "depends":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Depends = append(out.Depends, v22)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "enable_history":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.EnableHistory = append(out.EnableHistory, v23)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "component_infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v25 Info
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(in, &v25)
					(out.ComponentInfos)[key] = v25
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes3(out *jwriter.Writer, in Entity) {
	...
	}
	{
		...
		if in.EnableHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v30, v31 := range in.EnableHistory {
				if v30 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v32First := true
			for v32Name, v32Value := range in.Infos {
				if v32First {
					v32First = false
				} else {
					out.RawByte(',')
	...
	if len(in.ComponentInfos) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v33First := true
			for v33Name, v33Value := range in.ComponentInfos {
				if v33First {
					v33First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(out, v33Value)
			}
			out.RawByte('}')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "steps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v34 AlarmStep
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, &v34)
					out.Steps = append(out.Steps, v34)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "long_output_history":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LongOutputHistory = append(out.LongOutputHistory, v35)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "related_parents":
			if in.IsNull() {
				in.Skip()
				out.RelatedParents = nil
			} else {
				in.Delim('[')
				if out.RelatedParents == nil {
					if !in.IsDelim(']') {
						out.RelatedParents = make([]string, 0, 4)
					} else {
						out.RelatedParents = []string{}
					}
				} else {
					out.RelatedParents = (out.RelatedParents)[:0]
				}
				for !in.IsDelim(']') {
					var v37 string
					v37 = string(in.String())
					out.RelatedParents = append(out.RelatedParents, v37)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Parents = append(out.Parents, v38)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v40 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v40 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v41 interface{}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(out *jwriter.Writer, in AlarmValue) {
	...
	}
	{
		...
		if in.Steps == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v43, v44 := range in.Steps {
				if v43 > 0 {
					out.RawByte(',')
				}
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, v44)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.LongOutputHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v45, v46 := range in.LongOutputHistory {
				if v45 > 0 {
					out.RawByte(',')
				}
	...
	{
		const prefix string = ",\"related_parents\":"
		out.RawString(prefix)
		if in.RelatedParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
			for v49, v50 := range in.RelatedParents {
				if v49 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v55First := true
			for v55Name, v55Value := range in.Infos {
				if v55First {
					v55First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.RuleVersion == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v57First := true
			for v57Name, v57Value := range in.RuleVersion {
				if v57First {
					v57First = false
				} else {
					out.RawByte(',')
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(out *jwriter.Writer, in AlarmTicket) {
	...
	}
	{
		...
		if in.Data == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v59First := true
			for v59Name, v59Value := range in.Data {
				if v59First {
					v59First = false
				} else {
					out.RawByte(',')
