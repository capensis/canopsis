		...
		case "ma_related_parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v4 string
					v4 = string(in.String())
					out.MetaAlarmRelatedParents = append(out.MetaAlarmRelatedParents, v4)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes(out *jwriter.Writer, in Event) {
	...
	}
	{
		...
		if in.MetaAlarmRelatedParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v13, v14 := range in.MetaAlarmRelatedParents {
				if v13 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.MetaAlarmParents == nil {
			...
			if *in.MetaAlarmParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
				...
				out.RawByte('[')
				for v15, v16 := range *in.MetaAlarmParents {
					if v15 > 0 {
						out.RawByte(',')
					}
	...
	}
	{
		...
		if in.MetaAlarmChildren == nil {
			...
			if *in.MetaAlarmChildren == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
				...
				out.RawByte('[')
				for v17, v18 := range *in.MetaAlarmChildren {
					if v17 > 0 {
						out.RawByte(',')
					}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			for v34Name, v34Value := range in.Infos {
				...
				out.RawByte(':')
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(out, v34Value)
			}
			out.RawByte('}')
		}
	}
	if len(in.ComponentInfos) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v35Name, v35Value := range in.ComponentInfos {
				...
				out.RawByte(':')
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(out, v35Value)
			}
			out.RawByte('}')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "steps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v36 AlarmStep
					easyjsonF642ad3eDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, &v36)
					out.Steps = append(out.Steps, v36)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "long_output_history":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LongOutputHistory = append(out.LongOutputHistory, v37)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Parents = append(out.Parents, v39)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Children = append(out.Children, v40)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v41 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v41 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v42 interface{}
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(out *jwriter.Writer, in AlarmValue) {
	...
	}
	{
		...
		if in.Steps == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v44, v45 := range in.Steps {
				if v44 > 0 {
					out.RawByte(',')
				}
				easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, v45)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.LongOutputHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v46, v47 := range in.LongOutputHistory {
				if v46 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v54First := true
			for v54Name, v54Value := range in.Infos {
				if v54First {
					v54First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.RuleVersion == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v56First := true
			for v56Name, v56Value := range in.RuleVersion {
				if v56First {
					v56First = false
				} else {
					out.RawByte(',')
...
func easyjsonF642ad3eEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(out *jwriter.Writer, in AlarmTicket) {
	...
	}
	{
		...
		if in.Data == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v58First := true
			for v58Name, v58Value := range in.Data {
				if v58First {
					v58First = false
				} else {
					out.RawByte(',')
