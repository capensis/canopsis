...
type Rule struct {
	...
	Duration    libtime.DurationWithUnit `bson:"duration" json:"duration"`
	...
	Created              libtime.CpsTime `bson:"created,omitempty" json:"created,omitempty"`
	Updated              libtime.CpsTime `bson:"updated,omitempty" json:"updated,omitempty"`
...
type Parameters struct {
	...
	Duration *libtime.DurationWithUnit `json:"duration" bson:"duration,omitempty"`
	// Pbehavior
	...
	Tstart         *libtime.CpsTime `json:"tstart" bson:"tstart,omitempty"`
	Tstop          *libtime.CpsTime `json:"tstop" bson:"tstop,omitempty"`
...
func (r *Rule) Matches(alarmWithEntity types.AlarmWithEntity, now libtime.CpsTime) (bool, error) {
...
func (r *Rule) matchesByAlarmLastEventDate(alarm types.Alarm, now libtime.CpsTime) bool {
...
func (r *Rule) matchesByAlarmLastUpdateDate(alarm types.Alarm, now libtime.CpsTime) bool {
	before := r.Duration.SubFrom(now)
...
func (r *Rule) matchesByEntityLastEventDate(entity types.Entity, now libtime.CpsTime) bool {
