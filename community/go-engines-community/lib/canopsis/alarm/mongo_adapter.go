...
func (a mongoAdapter) PartialUpdateOpen(alarm *types.Alarm) error {
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
...
func (a mongoAdapter) GetOpenedAlarmsWithLastEventDateBefore(date time.Time) ([]types.AlarmWithEntity, error) {
	return a.getAlarmsWithEntity(bson.M{
...
func (a mongoAdapter) GetOpenedAlarmsWithLastUpdateDateBefore(date time.Time) ([]types.AlarmWithEntity, error) {
	return a.getAlarmsWithEntity(bson.M{
