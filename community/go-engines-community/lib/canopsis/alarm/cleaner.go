...
type Cleaner interface {
	...
	ArchiveResolvedAlarms(ctx context.Context, before libtime.CpsTime, limit int64) (int64, error)

	// DeleteArchivedResolvedAlarms deletes resolved alarms from archived collection after some time.
	DeleteArchivedResolvedAlarms(ctx context.Context, before libtime.CpsTime, limit int64) (int64, error)
}
...
func (c *cleaner) ArchiveResolvedAlarms(ctx context.Context, before libtime.CpsTime, limit int64) (int64, error) {
	opts := options.Find()
	if limit > 0 {
		opts.SetLimit(limit)
	}
...
func (c *cleaner) DeleteArchivedResolvedAlarms(ctx context.Context, before libtime.CpsTime, limit int64) (int64, error) {
