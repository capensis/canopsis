	...
	for !in.IsDelim('}') {
		...
		case "comments":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v7 types.EntityComment
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(in, &v7)
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes1(out *jwriter.Writer, in types.Entity) {
	...
	}
	{
		...
		if in.EnableHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v8, v9 := range in.EnableHistory {
				if v8 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v10First := true
			for v10Name, v10Value := range in.Infos {
				if v10First {
					v10First = false
				} else {
					out.RawByte(',')
	...
	if len(in.ComponentInfos) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v11First := true
			for v11Name, v11Value := range in.ComponentInfos {
				if v11First {
					v11First = false
				} else {
					out.RawByte(',')
	...
	if len(in.ServicesToAdd) != 0 {
		...
		{
			out.RawByte('[')
			for v14, v15 := range in.ServicesToAdd {
				if v14 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.ServicesToRemove) != 0 {
		...
		{
			out.RawByte('[')
			for v16, v17 := range in.ServicesToRemove {
				if v16 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Comments) != 0 {
		...
		{
			out.RawByte('[')
			for v18, v19 := range in.Comments {
				if v18 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(out, v19)
			}
			out.RawByte(']')
		}
	}
			...
			if in.IsNull() {
				...
				if in.IsNull() {
					...
					*out.InheritedPattern = nil
					...
					for !in.IsDelim(']') {
						var v20 []pattern.FieldCondition
						if in.IsNull() {
							in.Skip()
							v20 = nil
						} else {
							...
							if v20 == nil {
								if !in.IsDelim(']') {
									v20 = make([]pattern.FieldCondition, 0, 0)
								} else {
									v20 = []pattern.FieldCondition{}
								}
							} else {
								v20 = (v20)[:0]
							}
							for !in.IsDelim(']') {
								var v21 pattern.FieldCondition
								easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisPattern(in, &v21)
								v20 = append(v20, v21)
								in.WantComma()
							}
							in.Delim(']')
						}
						*out.InheritedPattern = append(*out.InheritedPattern, v20)
						in.WantComma()
					}
					in.Delim(']')
				}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes5(out *jwriter.Writer, in types.StateInfo) {
	...
	if in.InheritedPattern != nil {
		...
		if *in.InheritedPattern == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v22, v23 := range *in.InheritedPattern {
				if v22 > 0 {
					out.RawByte(',')
				}
				if v23 == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					...
					for v24, v25 := range v23 {
						...
						easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisPattern(out, v25)
					}
					out.RawByte(']')
				}
			}
	...
	for !in.IsDelim('}') {
		...
		case "etags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ExternalTags = append(out.ExternalTags, v27)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "itags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.InternalTags = append(out.InternalTags, v28)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "filter_ctags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterChildrenTagsByLabel = append(out.FilterChildrenTagsByLabel, v29)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "cinfos":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.EntityInfosFromChildren = append(out.EntityInfosFromChildren, v30)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "kpi_assigned_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.KpiAssignedInstructions = append(out.KpiAssignedInstructions, v31)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "kpi_executed_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.KpiExecutedInstructions = append(out.KpiExecutedInstructions, v32)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "kpi_assigned_auto_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.KpiAssignedAutoInstructions = append(out.KpiAssignedAutoInstructions, v33)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "kpi_executed_auto_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.KpiExecutedAutoInstructions = append(out.KpiExecutedAutoInstructions, v34)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "meta_alarm_inactive_delay":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v35 types.MetaAlarmInactiveDelay
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(in, &v35)
					out.MetaAlarmInactiveDelay = append(out.MetaAlarmInactiveDelay, v35)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes(out *jwriter.Writer, in types.Alarm) {
	...
	if len(in.ExternalTags) != 0 {
		...
		{
			out.RawByte('[')
			for v38, v39 := range in.ExternalTags {
				if v38 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.InternalTags) != 0 {
		...
		{
			out.RawByte('[')
			for v40, v41 := range in.InternalTags {
				if v40 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.FilterChildrenTagsByLabel) != 0 {
		...
		{
			out.RawByte('[')
			for v42, v43 := range in.FilterChildrenTagsByLabel {
				if v42 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.EntityInfosFromChildren) != 0 {
		...
		{
			out.RawByte('[')
			for v44, v45 := range in.EntityInfosFromChildren {
				if v44 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiAssignedInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v46, v47 := range in.KpiAssignedInstructions {
				if v46 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiExecutedInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v48, v49 := range in.KpiExecutedInstructions {
				if v48 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiAssignedAutoInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v50, v51 := range in.KpiAssignedAutoInstructions {
				if v50 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiExecutedAutoInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v52, v53 := range in.KpiExecutedAutoInstructions {
				if v52 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.MetaAlarmInactiveDelay) != 0 {
		...
		{
			out.RawByte('[')
			for v54, v55 := range in.MetaAlarmInactiveDelay {
				if v54 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(out, v55)
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "comments":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v56 types.AlarmStep
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(in, &v56)
					out.Comments = append(out.Comments, v56)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "tickets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v57 types.AlarmStep
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(in, &v57)
					out.Tickets = append(out.Tickets, v57)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "steps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v58 types.AlarmStep
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(in, &v58)
					out.Steps = append(out.Steps, v58)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "long_output_history":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LongOutputHistory = append(out.LongOutputHistory, v59)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Parents = append(out.Parents, v60)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Children = append(out.Children, v61)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "unlinked_parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.UnlinkedParents = append(out.UnlinkedParents, v62)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v63 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v63 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v64 interface{}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out *jwriter.Writer, in types.AlarmValue) {
	...
	if len(in.Comments) != 0 {
		...
		{
			out.RawByte('[')
			for v66, v67 := range in.Comments {
				if v66 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out, v67)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.Tickets) != 0 {
		...
		{
			out.RawByte('[')
			for v68, v69 := range in.Tickets {
				if v68 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out, v69)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Steps == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v70, v71 := range in.Steps {
				if v70 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out, v71)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.LongOutputHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v72, v73 := range in.LongOutputHistory {
				if v72 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.UnlinkedParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v78, v79 := range in.UnlinkedParents {
				if v78 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v80First := true
			for v80Name, v80Value := range in.Infos {
				if v80First {
					v80First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v80Value == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v81First := true
					for v81Name, v81Value := range v80Value {
						if v81First {
							v81First = false
						} else {
							out.RawByte(',')
	...
	}
	{
		...
		if in.RuleVersion == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v82First := true
			for v82Name, v82Value := range in.RuleVersion {
				if v82First {
					v82First = false
				} else {
					out.RawByte(',')
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out *jwriter.Writer, in types.AlarmStep) {
	...
	if len(in.TicketData) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v84First := true
			for v84Name, v84Value := range in.TicketData {
				if v84First {
					v84First = false
				} else {
					out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "ma_parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MetaAlarmParents = append(out.MetaAlarmParents, v87)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ma_children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MetaAlarmChildren = append(out.MetaAlarmChildren, v88)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "ma_infos":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v89 types.CorrelationRuleInfo
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, &v89)
					out.MetaAlarmInfos = append(out.MetaAlarmInfos, v89)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "added_to_services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AddedToServices = append(out.AddedToServices, v90)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "removed_from_services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RemovedFromServices = append(out.RemovedFromServices, v91)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes12(out *jwriter.Writer, in types.Event) {
	...
	}
	{
		...
		if in.ExtraInfos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v93First := true
			for v93Name, v93Value := range in.ExtraInfos {
				if v93First {
					v93First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Tags == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v94First := true
			for v94Name, v94Value := range in.Tags {
				if v94First {
					v94First = false
				} else {
					out.RawByte(',')
	...
	if len(in.MetaAlarmParents) != 0 {
		...
		{
			out.RawByte('[')
			for v95, v96 := range in.MetaAlarmParents {
				if v95 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.MetaAlarmChildren) != 0 {
		...
		{
			out.RawByte('[')
			for v97, v98 := range in.MetaAlarmChildren {
				if v97 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.MetaAlarmInfos) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v99, v100 := range in.MetaAlarmInfos {
				...
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, v100)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.AddedToServices) != 0 {
		...
		{
			out.RawByte('[')
			for v101, v102 := range in.AddedToServices {
				if v101 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.RemovedFromServices) != 0 {
		...
		{
			out.RawByte('[')
			for v103, v104 := range in.RemovedFromServices {
				if v103 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.TicketData) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v105First := true
			for v105Name, v105Value := range in.TicketData {
				if v105First {
					v105First = false
				} else {
					out.RawByte(',')
		...
		case "filter_by_label":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterByLabel = append(out.FilterByLabel, v106)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes13(out *jwriter.Writer, in types.CorrelationRuleTags) {
	...
	if len(in.FilterByLabel) != 0 {
		...
		{
			out.RawByte('[')
			for v107, v108 := range in.FilterByLabel {
				if v107 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "ma_infos":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v113 types.CorrelationRuleInfo
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(in, &v113)
					out.MetaAlarmInfos = append(out.MetaAlarmInfos, v113)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "meta_alarm_children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MetaAlarmChildren = append(out.MetaAlarmChildren, v114)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisRpc11(out *jwriter.Writer, in AxeParameters) {
	...
	if len(in.MetaAlarmInfos) != 0 {
		...
		{
			out.RawByte('[')
			for v117, v118 := range in.MetaAlarmInfos {
				if v117 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes14(out, v118)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.MetaAlarmChildren) != 0 {
		...
		{
			out.RawByte('[')
			for v119, v120 := range in.MetaAlarmChildren {
				if v119 > 0 {
					out.RawByte(',')
				}
