		...
		case "etags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v2 string
					v2 = string(in.String())
					out.ExternalTags = append(out.ExternalTags, v2)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "itags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v3 string
					v3 = string(in.String())
					out.InternalTags = append(out.InternalTags, v3)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "kpi_assigned_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v4 string
					v4 = string(in.String())
					out.KpiAssignedInstructions = append(out.KpiAssignedInstructions, v4)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "kpi_executed_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v5 string
					v5 = string(in.String())
					out.KpiExecutedInstructions = append(out.KpiExecutedInstructions, v5)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "kpi_assigned_auto_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v6 string
					v6 = string(in.String())
					out.KpiAssignedAutoInstructions = append(out.KpiAssignedAutoInstructions, v6)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "kpi_executed_auto_instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v7 string
					v7 = string(in.String())
					out.KpiExecutedAutoInstructions = append(out.KpiExecutedAutoInstructions, v7)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes(out *jwriter.Writer, in types.Alarm) {
	...
	if len(in.ExternalTags) != 0 {
		...
		{
			out.RawByte('[')
			for v10, v11 := range in.ExternalTags {
				if v10 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.InternalTags) != 0 {
		...
		{
			out.RawByte('[')
			for v12, v13 := range in.InternalTags {
				if v12 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiAssignedInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v14, v15 := range in.KpiAssignedInstructions {
				if v14 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiExecutedInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v16, v17 := range in.KpiExecutedInstructions {
				if v16 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiAssignedAutoInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v18, v19 := range in.KpiAssignedAutoInstructions {
				if v18 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiExecutedAutoInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v20, v21 := range in.KpiExecutedAutoInstructions {
				if v20 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "change_state":
			if in.IsNull() {
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes2(in, out.ChangeState)
			}
		case "tickets":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					var v22 types.AlarmStep
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes2(in, &v22)
					out.Tickets = append(out.Tickets, v22)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "steps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v23 types.AlarmStep
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes2(in, &v23)
		...
		case "long_output_history":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LongOutputHistory = append(out.LongOutputHistory, v24)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Parents = append(out.Parents, v25)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Children = append(out.Children, v26)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "unlinked_parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.UnlinkedParents = append(out.UnlinkedParents, v27)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes1(out *jwriter.Writer, in types.AlarmValue) {
	...
	if in.ChangeState != nil {
		...
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes2(out, *in.ChangeState)
	}
	if len(in.Tickets) != 0 {
		...
		{
			out.RawByte('[')
			for v31, v32 := range in.Tickets {
				if v31 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes2(out, v32)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Steps == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v33, v34 := range in.Steps {
				if v33 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes2(out, v34)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.LongOutputHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v35, v36 := range in.LongOutputHistory {
				if v35 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.UnlinkedParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v41, v42 := range in.UnlinkedParents {
				if v41 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v43First := true
			for v43Name, v43Value := range in.Infos {
				if v43First {
					v43First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v43Value == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v44First := true
					for v44Name, v44Value := range v43Value {
						if v44First {
							v44First = false
						} else {
							out.RawByte(',')
	...
	}
	{
		...
		if in.RuleVersion == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v45First := true
			for v45Name, v45Value := range in.RuleVersion {
				if v45First {
					v45First = false
				} else {
					out.RawByte(',')
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes2(out *jwriter.Writer, in types.AlarmStep) {
	...
	if len(in.TicketData) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v47First := true
			for v47Name, v47Value := range in.TicketData {
				if v47First {
					v47First = false
				} else {
					out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "enable_history":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v48 types.CpsTime
					if data := in.Raw(); in.Ok() {
						in.AddError((v48).UnmarshalJSON(data))
					}
					out.EnableHistory = append(out.EnableHistory, v48)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v49 types.Info
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(in, &v49)
					(out.Infos)[key] = v49
					in.WantComma()
				}
				in.Delim('}')
		...
		case "component_infos":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v50 types.Info
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(in, &v50)
					(out.ComponentInfos)[key] = v50
					in.WantComma()
				}
				in.Delim('}')
			}
		...
		case "services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Services = append(out.Services, v51)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "services_to_add":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ServicesToAdd = append(out.ServicesToAdd, v52)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "services_to_remove":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ServicesToRemove = append(out.ServicesToRemove, v53)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes5(out *jwriter.Writer, in types.Entity) {
	...
	}
	{
		...
		if in.EnableHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v54, v55 := range in.EnableHistory {
				if v54 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v56First := true
			for v56Name, v56Value := range in.Infos {
				if v56First {
					v56First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(out, v56Value)
			}
			out.RawByte('}')
		}
	}
	if len(in.ComponentInfos) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v57First := true
			for v57Name, v57Value := range in.ComponentInfos {
				if v57First {
					v57First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(out, v57Value)
			}
			out.RawByte('}')
		}
	}
	...
	if len(in.ServicesToAdd) != 0 {
		...
		{
			out.RawByte('[')
			for v60, v61 := range in.ServicesToAdd {
				if v60 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.ServicesToRemove) != 0 {
		...
		{
			out.RawByte('[')
			for v62, v63 := range in.ServicesToRemove {
				if v62 > 0 {
					out.RawByte(',')
				}
