...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out *jwriter.Writer, in types.AlarmValue) {
	...
	}
	{
		...
		if in.Steps == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v69, v70 := range in.Steps {
				if v69 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out, v70)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.LongOutputHistory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v71, v72 := range in.LongOutputHistory {
				if v71 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.UnlinkedParents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v77, v78 := range in.UnlinkedParents {
				if v77 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Infos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v79First := true
			for v79Name, v79Value := range in.Infos {
				if v79First {
					v79First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v79Value == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v80First := true
					for v80Name, v80Value := range v79Value {
						if v80First {
							v80First = false
						} else {
							out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "ma_infos":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v87 types.CorrelationRuleInfo
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes13(in, &v87)
					out.MetaAlarmInfos = append(out.MetaAlarmInfos, v87)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisRpc11(out *jwriter.Writer, in AxeParameters) {
	...
	if len(in.Tags) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v90First := true
			for v90Name, v90Value := range in.Tags {
				if v90First {
					v90First = false
				} else {
					out.RawByte(',')
	...
	if len(in.MetaAlarmInfos) != 0 {
		...
		{
			out.RawByte('[')
			for v91, v92 := range in.MetaAlarmInfos {
				if v91 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes13(out, v92)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.MetaAlarmChildren) != 0 {
		...
		{
			out.RawByte('[')
			for v93, v94 := range in.MetaAlarmChildren {
				if v93 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.TicketData) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v95First := true
			for v95Name, v95Value := range in.TicketData {
				if v95First {
					v95First = false
				} else {
					out.RawByte(',')
		...
		case "filter_by_label":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterByLabel = append(out.FilterByLabel, v96)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes12(out *jwriter.Writer, in types.CorrelationRuleTags) {
	...
	if len(in.FilterByLabel) != 0 {
		...
		{
			out.RawByte('[')
			for v97, v98 := range in.FilterByLabel {
				if v97 > 0 {
					out.RawByte(',')
				}
