	...
	for !in.IsDelim('}') {
		...
		case "meta_alarm_inactive_delay":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v30 types.MetaAlarmInactiveDelay
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(in, &v30)
					out.MetaAlarmInactiveDelay = append(out.MetaAlarmInactiveDelay, v30)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes(out *jwriter.Writer, in types.Alarm) {
	...
	}
	{
		...
		if in.ExternalTags == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v33, v34 := range in.ExternalTags {
				if v33 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.InternalTags == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v35, v36 := range in.InternalTags {
				if v35 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiAssignedAutoInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v41, v42 := range in.KpiAssignedAutoInstructions {
				if v41 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.KpiExecutedAutoInstructions) != 0 {
		...
		{
			out.RawByte('[')
			for v43, v44 := range in.KpiExecutedAutoInstructions {
				if v43 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.MetaAlarmInactiveDelay) != 0 {
		...
		{
			out.RawByte('[')
			for v45, v46 := range in.MetaAlarmInactiveDelay {
				if v45 > 0 {
					out.RawByte(',')
				}
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(out, v46)
			}
			out.RawByte(']')
		}
	}
...
func easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(in *jlexer.Lexer, out *types.MetaAlarmInactiveDelay) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes7(out *jwriter.Writer, in types.MetaAlarmInactiveDelay) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "ack":
			if in.IsNull() {
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, out.ACK)
			}
		case "canceled":
			if in.IsNull() {
				in.Skip()
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, out.Canceled)
			}
		case "snooze":
			if in.IsNull() {
				in.Skip()
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, out.Snooze)
			}
		case "state":
			if in.IsNull() {
				in.Skip()
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, out.State)
			}
		case "status":
			if in.IsNull() {
				in.Skip()
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, out.Status)
			}
		case "last_comment":
			if in.IsNull() {
				in.Skip()
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, out.LastComment)
			}
		case "change_state":
			if in.IsNull() {
				in.Skip()
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, out.ChangeState)
			}
		case "tickets":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					var v47 types.AlarmStep
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, &v47)
		...
		case "ticket":
			if in.IsNull() {
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, out.Ticket)
			}
		case "steps":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					var v48 types.AlarmStep
					easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in, &v48)
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes6(out *jwriter.Writer, in types.AlarmValue) {
	...
	if in.ACK != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, *in.ACK)
	}
	if in.Canceled != nil {
		...
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, *in.Canceled)
	}
	if in.Snooze != nil {
		...
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, *in.Snooze)
	}
	if in.State != nil {
		...
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, *in.State)
	}
	if in.Status != nil {
		...
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, *in.Status)
	}
	if in.LastComment != nil {
		...
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, *in.LastComment)
	}
	if in.ChangeState != nil {
		...
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, *in.ChangeState)
	}
	if len(in.Tickets) != 0 {
		...
		}
		{
			...
			for v56, v57 := range in.Tickets {
				...
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, v57)
			}
			out.RawByte(']')
		}
	}
	if in.Ticket != nil {
		...
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, *in.Ticket)
	}
	{
		...
		if in.Steps == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v58, v59 := range in.Steps {
				...
				easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out, v59)
			}
			out.RawByte(']')
		}
	}
...
func easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(in *jlexer.Lexer, out *types.AlarmStep) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "statecounter":
			easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(in, &out.StateCounter)
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes8(out *jwriter.Writer, in types.AlarmStep) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if true {
		...
		out.RawString(prefix)
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(out, in.StateCounter)
	}
...
func easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(in *jlexer.Lexer, out *types.CropCounter) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes9(out *jwriter.Writer, in types.CropCounter) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisRpc3(in *jlexer.Lexer, out *PbehaviorResultEvent) {
	...
	for !in.IsDelim('}') {
		...
		case "event":
			easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(in, &out.PbhEvent)
		case "error":
			if in.IsNull() {
				in.Skip()
				out.Error = nil
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisRpc3(out *jwriter.Writer, in PbehaviorResultEvent) {
	...
	}
	{
		...
		out.RawString(prefix)
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out, in.PbhEvent)
	}
	{
...
func easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(in *jlexer.Lexer, out *types.Event) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "ma_parents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MetaAlarmParents = append(out.MetaAlarmParents, v75)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "ma_children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MetaAlarmChildren = append(out.MetaAlarmChildren, v76)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "added_to_services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AddedToServices = append(out.AddedToServices, v77)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "removed_from_services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RemovedFromServices = append(out.RemovedFromServices, v78)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out *jwriter.Writer, in types.Event) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.ExtraInfos == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v80First := true
			for v80Name, v80Value := range in.ExtraInfos {
				if v80First {
					v80First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Tags == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v81First := true
			for v81Name, v81Value := range in.Tags {
				if v81First {
					v81First = false
				} else {
					out.RawByte(',')
	...
	if len(in.MetaAlarmParents) != 0 {
		...
		{
			out.RawByte('[')
			for v82, v83 := range in.MetaAlarmParents {
				if v82 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.MetaAlarmChildren) != 0 {
		...
		{
			out.RawByte('[')
			for v84, v85 := range in.MetaAlarmChildren {
				if v84 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AddedToServices) != 0 {
		...
		{
			out.RawByte('[')
			for v86, v87 := range in.AddedToServices {
				if v86 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.RemovedFromServices) != 0 {
		...
		{
			out.RawByte('[')
			for v88, v89 := range in.RemovedFromServices {
				if v88 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "origin":
			if in.IsNull() {
				...
				easyjson692db02bDecodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(in, out.Origin)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisRpc9(out *jwriter.Writer, in AxeResultEvent) {
	...
	if len(in.WebhookHeader) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v96First := true
			for v96Name, v96Value := range in.WebhookHeader {
				if v96First {
					v96First = false
				} else {
					out.RawByte(',')
	...
	if len(in.WebhookResponse) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v97First := true
			for v97Name, v97Value := range in.WebhookResponse {
				if v97First {
					v97First = false
				} else {
					out.RawByte(',')
	...
	if in.Origin != nil {
		...
		out.RawString(prefix)
		easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisTypes10(out, *in.Origin)
	}
	out.RawByte('}')
}
		...
		case "meta_alarm_children":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MetaAlarmChildren = append(out.MetaAlarmChildren, v101)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson692db02bEncodeGitCanopsisNetCanopsisCanopsisCommunityCommunityGoEnginesCommunityLibCanopsisRpc11(out *jwriter.Writer, in AxeParameters) {
	...
	if len(in.WebhookHeader) != 0 {
		...
		}
		{
			out.RawByte('{')
			v103First := true
			for v103Name, v103Value := range in.WebhookHeader {
				if v103First {
					v103First = false
				} else {
					out.RawByte(',')
	...
	if len(in.WebhookResponse) != 0 {
		...
		}
		{
			out.RawByte('{')
			v104First := true
			for v104Name, v104Value := range in.WebhookResponse {
				if v104First {
					v104First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if m, ok := v104Value.(easyjson.Marshaler); ok {
					m.MarshalEasyJSON(out)
				} else if m, ok := v104Value.(json.Marshaler); ok {
					out.Raw(m.MarshalJSON())
				} else {
					out.Raw(json.Marshal(v104Value))
				}
			}
			out.RawByte('}')
		}
	...
	if len(in.MetaAlarmChildren) != 0 {
		...
		{
			out.RawByte('[')
			for v106, v107 := range in.MetaAlarmChildren {
				if v106 > 0 {
					out.RawByte(',')
				}
