...
type AxeParameters struct {
	...
	Timestamp libtime.CpsTime `json:"timestamp,omitempty"`
	// ChangeState
	...
	Duration *libtime.DurationWithUnit `json:"duration,omitempty"`
	// Pbehavior enter
	...
	Tstart         *libtime.CpsTime `json:"tstart,omitempty"`
	Tstop          *libtime.CpsTime `json:"tstop,omitempty"`
