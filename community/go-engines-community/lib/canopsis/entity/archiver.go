...
type Archiver interface {
	...
	ArchiveUnlinkedResources(ctx context.Context, before datetime.CpsTime, limit int) ([]string, int64, error)
	ArchiveUnlinkedComponents(ctx context.Context, before datetime.CpsTime, limit int) ([]string, int64, error)
	ArchiveUnlinkedConnectors(ctx context.Context, before datetime.CpsTime, limit int) ([]string, int64, error)
...
func (a *archiver) ArchiveUnlinkedResources(ctx context.Context, before datetime.CpsTime, limit int) ([]string, int64, error) {
	pipeline := []bson.M{
		{"$match": bson.M{
...
func (a *archiver) ArchiveUnlinkedComponents(ctx context.Context, before datetime.CpsTime, limit int) ([]string, int64, error) {
	pipeline := []bson.M{
		{"$match": bson.M{
...
func (a *archiver) ArchiveUnlinkedConnectors(ctx context.Context, before datetime.CpsTime, limit int) ([]string, int64, error) {
	pipeline := []bson.M{
		{"$match": bson.M{
