...
const InvalidIDChars = "/?.$" // todo move this const

var deprecatedTrans ut.Translator

// registerDeprecatedTranslations
// todo remove when everything is refactored
func registerDeprecatedTranslations(v *validator.Validate, trans ut.Translator) {
	deprecatedTrans = trans
	...
	_ = v.RegisterTranslation("not_approver", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("not_approver", fe.Field())
		return t
	})
	...
	_ = v.RegisterTranslation("exist", trans, func(ut ut.Translator) error {
		return ut.Add("unique", "{0} already exists.", true)
	}, func(ut ut.Translator, fe validator.FieldError) string {
		t, _ := ut.T("unique", fe.Field())
		return t
	...
	_ = v.RegisterTranslation("oneoforempty", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("oneoforempty", fe.Field(), fe.Param())
		return t
	})
	_ = v.RegisterTranslation("url", trans, func(ut ut.Translator) error {
		...
		if !ok {
			panic("field error value is not a string")
		}
	...
	_ = v.RegisterTranslation("has_duplicates", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("has_duplicates", fe.Field())
		return t
	})
	_ = v.RegisterTranslation("has_duplicates_with", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("has_duplicates_with", fe.Field(), fe.Param())
		return t
	})
	...
	_ = v.RegisterTranslation("iscolororempty", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("iscolororempty", fe.Field())
		return t
	})
	_ = v.RegisterTranslation("metaalarm_config_invalid", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("metaalarm_config_invalid", fe.Field())
		return t
	})
	...
	_ = v.RegisterTranslation("multi_sort_invalid", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("multi_sort_invalid", fe.Field())
		return t
	})
	...
	_ = v.RegisterTranslation("event_pattern", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("event_pattern", fe.Field())
		return t
	})
	_ = v.RegisterTranslation("alarm_pattern", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("alarm_pattern", fe.Field())
		return t
	})
	_ = v.RegisterTranslation("entity_pattern", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("entity_pattern", fe.Field())
		return t
	})
	_ = v.RegisterTranslation("pbehavior_pattern", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("pbehavior_pattern", fe.Field())
		return t
	})
	_ = v.RegisterTranslation("weather_service_pattern", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("weather_service_pattern", fe.Field())
		return t
	})
	...
	_ = v.RegisterTranslation("invalid", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("invalid", fe.Field())
		return t
	})
	_ = v.RegisterTranslation("not_supported", trans, func(ut ut.Translator) error {
		return ut.Add("not_supported", "{0} is not supported.", true)
	}, func(ut ut.Translator, fe validator.FieldError) string {
		t, _ := ut.T("not_supported", fe.Field())
		return t
	})
	_ = v.RegisterTranslation("not_applicable", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("not_applicable", fe.Field())
		return t
	})
	_ = v.RegisterTranslation("excluded_unless", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("excluded_unless", fe.Field(), fe.Param())
		return t
	})
	_ = v.RegisterTranslation("not_ui_perm", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("not_ui_perm", fe.Field(), fe.Param())
		return t
	})
	_ = v.RegisterTranslation("not_api_perm", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("not_api_perm", fe.Field(), fe.Param())
		return t
	})
	_ = v.RegisterTranslation("table_name", trans, func(ut ut.Translator) error {
		...
		t, _ := ut.T("table_name", fe.Field(), fe.Param())
		return t
	})
	_ = v.RegisterTranslation("unauth", trans, func(ut ut.Translator) error {
		return ut.Add("unauth", "{0} is not accessible.", true)
	}, func(ut ut.Translator, fe validator.FieldError) string {
...
func TranslateError(fe validator.FieldError) string {
	return fe.Translate(deprecatedTrans)
}
