...
type ArchiveUnlinkedRequest struct {
	ArchiveBefore libtime.DurationWithUnit `json:"archive_before"`
}

type CleanTask struct {
	Type                    int
	ArchiveWithDependencies bool
	ArchiveBefore           *libtime.DurationWithUnit
	UserID                  string
}
...
type Entity struct {
	...
	IdleSince      *libtime.CpsTime `bson:"idle_since,omitempty" json:"idle_since,omitempty" swaggertype:"integer"`
	LastEventDate  *libtime.CpsTime `bson:"last_event_date,omitempty" json:"last_event_date,omitempty" swaggertype:"integer"`

	PbehaviorInfo     *PbehaviorInfo   `bson:"pbehavior_info,omitempty" json:"pbehavior_info,omitempty"`
	LastPbehaviorDate *libtime.CpsTime `bson:"last_pbehavior_date,omitempty" json:"last_pbehavior_date,omitempty" swaggertype:"integer"`
	...
	AlarmLastUpdateDate *libtime.CpsTime  `bson:"alarm_last_update_date" json:"alarm_last_update_date,omitempty" swaggertype:"integer"`
	...
	Imported     *libtime.CpsTime `bson:"imported,omitempty" json:"imported,omitempty" swaggertype:"integer"`
