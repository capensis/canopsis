...
type EditRequest struct {
	Duration    *libtime.DurationWithUnit `json:"duration"`
...
type Response struct {
	...
	Accessed    libtime.CpsTime  `bson:"accessed" json:"accessed" swaggertype:"integer"`
	Expired     *libtime.CpsTime `bson:"expired" json:"expired" swaggertype:"integer"`
}
