...
import (
	...
	"git.canopsis.net/canopsis/go-engines/lib/security/configprovider"
	"git.canopsis.net/canopsis/go-engines/lib/security/httpprovider"
	"git.canopsis.net/canopsis/go-engines/lib/security/password"
	"git.canopsis.net/canopsis/go-engines/lib/security/provider"
...
func (s *security) newBaseAuthProvider() libsecurity.Provider {
	return provider.NewBaseProvider(s.newUserProvider(), password.NewSha1Encoder())
}
