...
type Service struct {
	...
	LastUpdateDate *libtime.CpsTime      `json:"last_update_date" bson:"last_update_date" swaggertype:"integer"`
	...
	IdleSince      *libtime.CpsTime      `json:"idle_since,omitempty" bson:"idle_since,omitempty" swaggertype:"integer"`
}
...
type Entity struct {
	...
	LastUpdateDate *libtime.CpsTime           `json:"last_update_date" bson:"last_update_date" swaggertype:"integer"`
	CreationDate   *libtime.CpsTime           `json:"alarm_creation_date" bson:"creation_date" swaggertype:"integer"`
