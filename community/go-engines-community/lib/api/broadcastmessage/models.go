...
type Payload struct {
	...
	Start   libtime.CpsTime `bson:"start" json:"start" binding:"required" swaggertype:"integer"`
	End     libtime.CpsTime `bson:"end" json:"end" binding:"required" swaggertype:"integer"`
