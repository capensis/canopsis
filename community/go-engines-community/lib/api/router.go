...
import (
	...
	"git.canopsis.net/canopsis/go-engines/lib/api/appinfo"
	"git.canopsis.net/canopsis/go-engines/lib/api/associativetable"
	"git.canopsis.net/canopsis/go-engines/lib/api/auth"
	"git.canopsis.net/canopsis/go-engines/lib/api/broadcastmessage"
	"git.canopsis.net/canopsis/go-engines/lib/api/contextgraph"
	"git.canopsis.net/canopsis/go-engines/lib/api/datastorage"
	...
	"git.canopsis.net/canopsis/go-engines/lib/api/event"
	"git.canopsis.net/canopsis/go-engines/lib/api/eventfilter"
	"git.canopsis.net/canopsis/go-engines/lib/api/export"
	"git.canopsis.net/canopsis/go-engines/lib/api/heartbeat"
	"git.canopsis.net/canopsis/go-engines/lib/api/idlerule"
	...
	"git.canopsis.net/canopsis/go-engines/lib/api/permission"
	"git.canopsis.net/canopsis/go-engines/lib/api/playlist"
	...
	"git.canopsis.net/canopsis/go-engines/lib/api/statesettings"
	"git.canopsis.net/canopsis/go-engines/lib/api/user"
	"git.canopsis.net/canopsis/go-engines/lib/api/view"
	...
	libentityservice "git.canopsis.net/canopsis/go-engines/lib/canopsis/entityservice"
