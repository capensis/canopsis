...
type EditRequest struct {
	...
	PeriodicRefresh *libtime.DurationWithEnabled `json:"periodic_refresh"`
}
...
type Response struct {
	...
	PeriodicRefresh *libtime.DurationWithEnabled `bson:"periodic_refresh" json:"periodic_refresh"`
