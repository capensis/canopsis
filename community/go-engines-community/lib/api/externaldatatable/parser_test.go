...
func TestParseNumber(t *testing.T) {
	testCases := []struct {
		...
		{
			name:               "given simple integer with no delimiters expect valid parsing",
			input:              "1000",
			thousandsDelimiter: "",
			decimalDelimiter:   "",
			expectedResult:     1000,
		...
		{
			name:               "given negative integer with no delimiters expect valid parsing",
			input:              "-1000",
			thousandsDelimiter: "",
			decimalDelimiter:   "",
			expectedResult:     -1000,
		...
		{
			name:               "given decimal number with no delimiters expect valid parsing",
			input:              "12.34",
			thousandsDelimiter: "",
			decimalDelimiter:   "",
		...
		{
			name:               "given negative decimal number with no delimiters expect valid parsing",
			input:              "-12.34",
			thousandsDelimiter: "",
			decimalDelimiter:   "",
			expectedResult:     -12.34,
		...
		{
			name:               "given zero with no delimiters expect valid parsing",
			input:              "0",
			thousandsDelimiter: "",
			decimalDelimiter:   "",
			expectedResult:     0,
		...
		{
			name:                 "given negative zero with no delimiters expect error",
			input:                "-0",
			thousandsDelimiter:   "",
			decimalDelimiter:     "",
		...
		{
			name:               "given small decimal with no delimiters expect valid parsing",
			input:              "0.001",
			thousandsDelimiter: "",
			decimalDelimiter:   "",
		...
		{
			name:               "given negative small decimal with no delimiters expect valid parsing",
			input:              "-0.001",
			thousandsDelimiter: "",
			decimalDelimiter:   "",
			expectedResult:     -0.001,
		...
		{
			name:                 "given number with spaces and no delimiters expect error",
			input:                "1 000",
			thousandsDelimiter:   "",
			decimalDelimiter:     "",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:                 "given number with comma and no delimiters expect error",
			input:                "12,34",
			thousandsDelimiter:   "",
			decimalDelimiter:     "",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:               "given integer with space thousands delimiter expect valid parsing",
			input:              "1 000",
			thousandsDelimiter: "space",
			decimalDelimiter:   "",
			expectedResult:     1000,
		},
		{
			name:               "given negative integer with space thousands delimiter expect valid parsing",
			input:              "-1 000",
			thousandsDelimiter: "space",
			decimalDelimiter:   "",
			expectedResult:     -1000,
		...
		{
			name:               "given large number with space thousands delimiter expect valid parsing",
			input:              "1 000 000",
			thousandsDelimiter: "space",
			decimalDelimiter:   "",
		...
		{
			name:               "given negative large number with space thousands delimiter expect valid parsing",
			input:              "-1 000 000",
			thousandsDelimiter: "space",
			decimalDelimiter:   "",
			expectedResult:     -1000000,
		...
		{
			name:               "given integer with comma thousands delimiter expect valid parsing",
			input:              "1,000",
			thousandsDelimiter: "comma",
			decimalDelimiter:   "",
			expectedResult:     1000,
		},
		{
			name:               "given negative integer with comma thousands delimiter expect valid parsing",
			input:              "-1,000",
			thousandsDelimiter: "comma",
			decimalDelimiter:   "",
			expectedResult:     -1000,
		...
		{
			name:               "given large number with comma thousands delimiter expect valid parsing",
			input:              "1,000,000",
			thousandsDelimiter: "comma",
			decimalDelimiter:   "",
			expectedResult:     1000000,
		...
		{
			name:               "given negative large number with comma thousands delimiter expect valid parsing",
			input:              "-1,000,000",
			thousandsDelimiter: "comma",
			decimalDelimiter:   "",
			expectedResult:     -1000000,
		...
		{
			name:               "given integer with dot thousands delimiter expect valid parsing",
			input:              "1.000",
			thousandsDelimiter: "dot",
			decimalDelimiter:   "",
			expectedResult:     1000,
		},
		{
			name:               "given negative integer with dot thousands delimiter expect valid parsing",
			input:              "-1.000",
			thousandsDelimiter: "dot",
			decimalDelimiter:   "",
			expectedResult:     -1000,
		...
		{
			name:               "given large number with dot thousands delimiter expect valid parsing",
			input:              "1.000.000",
			thousandsDelimiter: "dot",
			decimalDelimiter:   "",
			expectedResult:     1000000,
		...
		{
			name:               "given negative large number with dot thousands delimiter expect valid parsing",
			input:              "-1.000.000",
			thousandsDelimiter: "dot",
			decimalDelimiter:   "",
			expectedResult:     -1000000,
		...
		{
			name:                 "given double delimiter expect error",
			input:                "1,,000",
			thousandsDelimiter:   "comma",
			decimalDelimiter:     "",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:                 "given integer with leading zero and thousands delimiter expect error",
			input:                "01,000",
			thousandsDelimiter:   "comma",
			decimalDelimiter:     "",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:                 "given negative integer with leading zero and thousands delimiter expect error",
			input:                "-01,000",
			thousandsDelimiter:   "comma",
			decimalDelimiter:     "",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:               "given integer with dot decimal delimiter expect valid parsing",
			input:              "1000",
			thousandsDelimiter: "",
		...
		{
			name:               "given negative integer with dot decimal delimiter expect valid parsing",
			input:              "-1000",
			thousandsDelimiter: "",
			decimalDelimiter:   "dot",
			expectedResult:     -1000,
		...
		{
			name:               "given decimal number with dot delimiter expect valid parsing",
			input:              "1234.56",
			thousandsDelimiter: "",
			decimalDelimiter:   "dot",
		...
		{
			name:               "given negative decimal number with dot delimiter expect valid parsing",
			input:              "-1234.56",
			thousandsDelimiter: "",
			decimalDelimiter:   "dot",
			expectedResult:     -1234.56,
		...
		{
			name:               "given integer with comma decimal delimiter expect valid parsing",
			input:              "1000",
			thousandsDelimiter: "",
			decimalDelimiter:   "comma",
			expectedResult:     1000,
		},
		{
			name:               "given negative integer with comma decimal delimiter expect valid parsing",
			input:              "-1000",
			thousandsDelimiter: "",
			decimalDelimiter:   "comma",
			expectedResult:     -1000,
		...
		{
			name:               "given decimal number with comma delimiter expect valid parsing",
			input:              "1234,56",
			thousandsDelimiter: "",
			decimalDelimiter:   "comma",
			expectedResult:     1234.56,
		...
		{
			name:               "given negative decimal number with comma delimiter expect valid parsing",
			input:              "-1234,56",
			thousandsDelimiter: "",
			decimalDelimiter:   "comma",
			expectedResult:     -1234.56,
		...
		{
			name:                 "given comma in number with dot decimal delimiter expect error",
			input:                "1000,50",
			thousandsDelimiter:   "",
			decimalDelimiter:     "dot",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:                 "given dot in number with comma decimal delimiter expect error",
			input:                "1000.50",
			thousandsDelimiter:   "",
			decimalDelimiter:     "comma",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:                 "given decimal with leading zero and comma delimiter expect error",
			input:                "01,50",
			thousandsDelimiter:   "",
			decimalDelimiter:     "comma",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:                 "given negative decimal with leading zero and comma delimiter expect error",
			input:                "-01,50",
			thousandsDelimiter:   "",
			decimalDelimiter:     "comma",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:               "given valid zero with decimal and comma delimiter expect valid parsing",
			input:              "0,0",
			thousandsDelimiter: "",
			decimalDelimiter:   "comma",
			expectedResult:     0,
		...
		{
			name:               "given same delimiter for thousands and decimal expect valid parsing",
			input:              "0.0",
			thousandsDelimiter: "dot",
			decimalDelimiter:   "dot",
			expectedResult:     0,
		...
		{
			name:               "given negative same delimiter for thousands and decimal expect valid parsing",
			input:              "-0.0",
			thousandsDelimiter: "dot",
			decimalDelimiter:   "dot",
			expectedResult:     0,
		...
		{
			name:                 "given leading delimiter expect error",
			input:                " 1000",
			thousandsDelimiter:   "space",
			decimalDelimiter:     "dot",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:                 "given trailing delimiter expect error",
			input:                "1000 ",
			thousandsDelimiter:   "space",
			decimalDelimiter:     "dot",
			expectedErrorMessage: errStringIsNotAValidNumber.Error(),
		...
		{
			name:                 "given invalid thousands delimiter expect error",
			input:                "42",
			thousandsDelimiter:   "\xcb",
			decimalDelimiter:     "",
			expectedErrorMessage: "thousands delimiter must be one of \",\", \".\", \" \" or empty",
		},
		{
			name:                 "given invalid decimal delimiter expect error",
			input:                "42",
			thousandsDelimiter:   "",
			decimalDelimiter:     "\xcb",
			expectedErrorMessage: "decimal delimiter must be one of \".\", \",\" or empty",
		},
		{
			name:                 "given invalid both delimiters expect error",
			input:                "42",
			thousandsDelimiter:   "+",
			decimalDelimiter:     "[",
			expectedErrorMessage: "thousands delimiter must be one of \",\", \".\", \" \" or empty",
		...
		t.Run(tc.name, func(t *testing.T) {
			rawResult, err := p.Parse(externaldata.ColumnConfig{
				BaseColumnConfig: externaldata.BaseColumnConfig{
					...
					ThousandsDelimiter: tc.thousandsDelimiter,
					DecimalDelimiter:   tc.decimalDelimiter,
				},
			}, tc.input)
			if err != nil {
...
func FuzzParseNumber(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, input string, thousandsDelimiter string, decimalDelimiter string) {
		rawResult, err := p.Parse(externaldata.ColumnConfig{
			BaseColumnConfig: externaldata.BaseColumnConfig{
				Type:               externaldata.ColumnTypeNumber,
		...
		if err != nil && result != 0 {
			t.Errorf("parse returned non-zero result %v with error %v for input %q, thousands %q, decimal %q", result, err, input, thousandsDelimiter, decimalDelimiter)
		}
	})
}
...
func TestParseStringArray(t *testing.T) {
	testCases := []struct {
		...
		{
			name:           "given comma separated string expect successful delimiter array parsing",
			input:          "a,b,c",
			arrayType:      delimiterArray,
			delimiter:      ",",
			expectedResult: []string{"a", "b", "c"},
		},
		{
			name:           "given semicolon separated string expect successful delimiter array parsing",
			input:          "a;b;c",
			arrayType:      delimiterArray,
			delimiter:      ";",
			expectedResult: []string{"a", "b", "c"},
		...
		{
			name:           "given string with multi-character delimiter expect successful delimiter array parsing",
			input:          "a::b::c",
			arrayType:      delimiterArray,
			delimiter:      "::",
			expectedResult: []string{"a", "b", "c"},
		...
		{
			name:           "given single element string expect successful delimiter array parsing",
			input:          "single",
			arrayType:      delimiterArray,
			delimiter:      ",",
			expectedResult: []string{"single"},
		...
		{
			name:           "given string with empty elements expect successful delimiter array parsing",
			input:          "a,,c",
			arrayType:      delimiterArray,
			delimiter:      ",",
		...
		{
			name:           "given string with leading and trailing delimiters expect successful delimiter array parsing",
			input:          ",a,b,c,",
			arrayType:      delimiterArray,
			delimiter:      ",",
			expectedResult: []string{"", "a", "b", "c", ""},
		...
		{
			name:           "given empty string for delimiter array expect successful parsing",
			input:          "",
			arrayType:      delimiterArray,
			delimiter:      ",",
			expectedResult: []string{},
		...
		{
			name:                 "given delimiter array with empty delimiter expect error",
			input:                "test",
			arrayType:            delimiterArray,
			delimiter:            "",
			expectedResult:       nil,
			expectedErrorMessage: "string array delimiter is required",
		},
		{
		...
		t.Run(tc.name, func(t *testing.T) {
			raw, err := p.Parse(externaldata.ColumnConfig{
				BaseColumnConfig: externaldata.BaseColumnConfig{
					...
					StringArrayDelimiter: tc.delimiter,
				},
			}, tc.input)
			if err != nil {
				if tc.expectedErrorMessage == "" {
...
func FuzzParseStringArray(f *testing.F) {
	...
	f.Add("a,b,c", delimiterArray, ",")
	f.Add(`[]`, jsonArray, "")
	f.Add("", delimiterArray, ",")
	f.Add(`["test"]`, jsonArray, "")
	f.Add("single", delimiterArray, ",")
	f.Add("a;b;c", delimiterArray, ";")
	...
	f.Fuzz(func(t *testing.T, input string, arrayType int, delimiter string) {
		result, err := p.Parse(externaldata.ColumnConfig{
			BaseColumnConfig: externaldata.BaseColumnConfig{
				Type:                 externaldata.ColumnTypeStringArray,
				StringArrayType:      arrayType,
				StringArrayDelimiter: delimiter,
			},
		}, input)
