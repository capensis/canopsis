...
type Payload struct {
	...
	FlappingFreqLimit int                       `bson:"flapping_freq_limit" json:"flapping_freq_limit" binding:"required,gt=0"`
	FlappingInterval  types.DurationWithUnit    `bson:"flapping_interval" json:"flapping_interval" binding:"required"`
