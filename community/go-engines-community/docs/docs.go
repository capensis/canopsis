                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/pattern.BulkDeleteRequestItem"
                            }
                        }
                    }
                ],
                    ...
                    "207": {
                        ...
                        "schema": {
                            ...
                            "items": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/pattern.BulkDeleteResponseItem"
                                }
                            }
                        }
                    },
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/pattern.Response"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pattern.EditRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "pattern.Alarm": {
            ...
            "items": {
                "type": "array",
                "items": {
                    "$ref": "#/definitions/pattern.FieldCondition"
                }
            }
        },
        ...
        "pattern.BulkDeleteResponseItem": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string"
        ...
        "pattern.FieldCondition": {
            ...
            "properties": {
                "cond": {
                    "type": "object",
                    "$ref": "#/definitions/pattern.Condition"
                },
                "field": {
                    "type": "string"
                },
                "field_type": {
                    "description": "FieldType is only defined for custom fields, ex: infos.",
                    "type": "string"
                }
            }
        },
        ...
        "view.ExportResponse": {
            ...
            "properties": {
                "groups": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/view.ExportViewGroupResponse"
                    }
                },
                "views": {
                    "type": "array",
        ...
        "widgetfilter.Response": {
            ...
            "properties": {
                ...
                "corporate_pbehavior_pattern_title": {
                    "type": "string"
                },
                "created": {
                    "type": "integer"
