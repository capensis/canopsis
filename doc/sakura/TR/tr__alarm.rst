...
Alarm step "statedeccounter" data model
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. csv-table::
   ...
   m, step message, ````
   val, counter, number of statedec steps since last status change

Alarm step "stateinccounter" data model
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. csv-table::
   :header: Field, Description, Default Value

   _t, step type, ``stateinccounter``
   t, step timestamp, timestamp of last status change
   a, step author, author of last status change
   m, step message, ````
   val, counter, number of stateinc steps since last status change

Alarm step "state0counter" data model
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. csv-table::
   :header: Field, Description, Default Value

   _t, step type, ``state0counter``
   t, step timestamp, timestamp of last status change
   a, step author, author of last status change
   m, step message, ````
   val, counter, number of state where val=0 since last status change

Alarm step "state1counter" data model
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. csv-table::
   :header: Field, Description, Default Value

   _t, step type, ``state1counter``
   t, step timestamp, timestamp of last status change
   a, step author, author of last status change
   m, step message, ````
   val, counter, number of state where val=1 since last status change

Alarm step "state2counter" data model
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. csv-table::
   :header: Field, Description, Default Value

   _t, step type, ``state2counter``
   t, step timestamp, timestamp of last status change
   a, step author, author of last status change
   m, step message, ````
   val, counter, number of state where val=2 since last status change

Alarm step "state3counter" data model
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. csv-table::
   :header: Field, Description, Default Value

   _t, step type, ``state3counter``
   t, step timestamp, timestamp of last status change
   a, step author, author of last status change
   m, step message, ````
   val, counter, number of state where val=3 since last status change
