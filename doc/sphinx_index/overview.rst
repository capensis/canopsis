...
`Canopsis <http://canopsis.org>`_ is an open-source `hypervisor <http://www.capensis.fr/solutions/hypervision/>`_ whose goal is to |Sakura_aconsolidation| information and events (containing |Sakura_metricsPage| of different types such as performance, availability, etc.) coming from multiple sources to create a global solution for |Sakura_monitoring| and |Sakura_administrating| resources.
...
A |Sakura_glossary| page is also given for better descriptions about canopsis concepts.
