...
BuildRequires: rsync
Requires: bzip2 cyrus-sasl curl epel-release libacl libcurl libevent libffi librsync libxml2 libxslt net-snmp openldap openssl python rsync sudo xmlsec1 xmlsec1-openssl zlib
