...
BuildRequires: rsync
Requires: zlib libevent libcurl openssl bzip2 cyrus-sasl python openldap libxml2 rsync librsync libacl libxslt libffi xmlsec1 xmlsec1-openssl net-snmp epel-release sudo
